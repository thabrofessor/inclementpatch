...
// Item config
#define I_SHINY_CHARM_REROLLS   33       // Amount of re-rolls if the player has the Shiny Charm. Set to 0 to disable Shiny Charm's effects.
...
#define I_LEGACY_HEALING_ITEMS  GEN_6   // In Gen7+, certain healing items recover less HP than they used to.
