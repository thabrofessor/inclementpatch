const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_DEERLING] = _("Deerling Sp"),
    [SPECIES_SAWSBUCK] = _("Sawsbuck Sp"),
    ...
    [SPECIES_VIVILLON] = _("Vivillon Icy"),
    ...
    [SPECIES_PUMPKABOO] = _("Pumpkaboo Ave"),
    [SPECIES_GOURGEIST] = _("Gourgeist Ave"),
    ...
    [SPECIES_SILVALLY] = _("SilvalyNormal"),
    ...
    [SPECIES_TOXTRICITY] = _("ToxtricityAmp"),
    ...
    [SPECIES_CHARIZARD_MEGA_X] = _("Charizard X"),
    [SPECIES_CHARIZARD_MEGA_Y] = _("Charizard Y"),
    [SPECIES_BLASTOISE_MEGA] = _("MegaBlastoise"),
    [SPECIES_BEEDRILL_MEGA] = _("Mega Beedrill"),
    [SPECIES_PIDGEOT_MEGA] = _("Mega Pidgeot"),
    [SPECIES_ALAKAZAM_MEGA] = _("Mega Alakazam"),
    [SPECIES_SLOWBRO_MEGA] = _("Mega Slowbro"),
    [SPECIES_GENGAR_MEGA] = _("Mega Gengar"),
    [SPECIES_KANGASKHAN_MEGA] = _("MegaKangaskan"),
    [SPECIES_PINSIR_MEGA] = _("Mega Pinsir"),
    [SPECIES_GYARADOS_MEGA] = _("Mega Gyarados"),
    [SPECIES_AERODACTYL_MEGA] = _("MegaAerodactl"),
    [SPECIES_MEWTWO_MEGA_X] = _("Mega Mewtwo X"),
    [SPECIES_MEWTWO_MEGA_Y] = _("Mega Mewtwo Y"),
    [SPECIES_AMPHAROS_MEGA] = _("Mega Ampharos"),
    [SPECIES_STEELIX_MEGA] = _("Mega Steelix"),
    [SPECIES_SCIZOR_MEGA] = _("Mega Scizor"),
    [SPECIES_HERACROSS_MEGA] = _("MegaHeracross"),
    [SPECIES_HOUNDOOM_MEGA] = _("Mega Houndoom"),
    [SPECIES_TYRANITAR_MEGA] = _("MegaTyranitar"),
    [SPECIES_SCEPTILE_MEGA] = _("Mega Sceptile"),
    [SPECIES_BLAZIKEN_MEGA] = _("Mega Blaziken"),
    [SPECIES_SWAMPERT_MEGA] = _("Mega Swampert"),
    [SPECIES_GARDEVOIR_MEGA] = _("MegaGardevoir"),
    [SPECIES_SABLEYE_MEGA] = _("Mega Sableye"),
    [SPECIES_MAWILE_MEGA] = _("Mega Mawile"),
    [SPECIES_AGGRON_MEGA] = _("Mega Aggron"),
    [SPECIES_MEDICHAM_MEGA] = _("Mega Medicham"),
    [SPECIES_MANECTRIC_MEGA] = _("MegaManectric"),
    [SPECIES_SHARPEDO_MEGA] = _("Mega Sharpedo"),
    [SPECIES_CAMERUPT_MEGA] = _("Mega Camerupt"),
    [SPECIES_ALTARIA_MEGA] = _("Mega Altaria"),
    [SPECIES_BANETTE_MEGA] = _("Mega Banette"),
    [SPECIES_ABSOL_MEGA] = _("Mega Absol"),
    [SPECIES_GLALIE_MEGA] = _("Mega Glalie"),
    [SPECIES_SALAMENCE_MEGA] = _("Mega Salamence"),
    [SPECIES_METAGROSS_MEGA] = _("MegaMetagross"),
    [SPECIES_LATIAS_MEGA] = _("Mega Latias"),
    [SPECIES_LATIOS_MEGA] = _("Mega Latios"),
    [SPECIES_LOPUNNY_MEGA] = _("Mega Lopunny"),
    [SPECIES_GARCHOMP_MEGA] = _("Mega Garchomp"),
    [SPECIES_LUCARIO_MEGA] = _("Mega Lucario"),
    [SPECIES_ABOMASNOW_MEGA] = _("MegaAbomasnow"),
    [SPECIES_GALLADE_MEGA] = _("Mega Gallade"),
    [SPECIES_AUDINO_MEGA] = _("Mega Audino"),
    [SPECIES_DIANCIE_MEGA] = _("Mega Diancie"),
    [SPECIES_MILOTIC_MEGA] = _("Mega Milotic"),
    [SPECIES_BUTTERFREE_MEGA] = _("MegaButterfre"),
    [SPECIES_MACHAMP_MEGA] = _("Mega Machamp"),
    [SPECIES_KINGLER_MEGA] = _("Mega Kingler"),
    ...
    [SPECIES_GROUDON_PRIMAL] = _("GroudonPrimal"),

    // Alolan Forms
    [SPECIES_RATTATA_ALOLAN] = _("Alola Rattata"),
    [SPECIES_RATICATE_ALOLAN] = _("AlolaRaticate"),
    [SPECIES_RAICHU_ALOLAN] = _("Alola Raichu"),
    [SPECIES_SANDSHREW_ALOLAN] = _("AlolSandshrew"),
    [SPECIES_SANDSLASH_ALOLAN] = _("AlolSandslash"),
    [SPECIES_VULPIX_ALOLAN] = _("Alola Vulpix"),
    [SPECIES_NINETALES_ALOLAN] = _("AlolNinetales"),
    [SPECIES_DIGLETT_ALOLAN] = _("Alola Diglett"),
    [SPECIES_DUGTRIO_ALOLAN] = _("Alola Dugtrio"),
    [SPECIES_MEOWTH_ALOLAN] = _("Alola Meowth"),
    [SPECIES_PERSIAN_ALOLAN] = _("Alola Persian"),
    [SPECIES_GEODUDE_ALOLAN] = _("Alola Geodude"),
    [SPECIES_GRAVELER_ALOLAN] = _("AlolaGraveler"),
    [SPECIES_GOLEM_ALOLAN] = _("Alola Golem"),
    [SPECIES_GRIMER_ALOLAN] = _("Alola Grimer"),
    [SPECIES_MUK_ALOLAN] = _("Alola Muk"),
    [SPECIES_EXEGGUTOR_ALOLAN] = _("AlolExeggutor"),
    [SPECIES_MAROWAK_ALOLAN] = _("Alola Marowak"),

    // Galarian Forms
    [SPECIES_MEOWTH_GALARIAN] = _("Galar Meowth"),
    [SPECIES_PONYTA_GALARIAN] = _("Galar Ponyta"),
    [SPECIES_RAPIDASH_GALARIAN] = _("GalarRapidash"),
    [SPECIES_SLOWPOKE_GALARIAN] = _("GalarSlowpoke"),
    [SPECIES_SLOWBRO_GALARIAN] = _("Galar Slowbro"),
    [SPECIES_FARFETCHD_GALARIAN] = _("GalarFarfetch"),
    [SPECIES_WEEZING_GALARIAN] = _("Galar Weezing"),
    [SPECIES_MR_MIME_GALARIAN] = _("Galar Mr.Mime"),
    [SPECIES_ARTICUNO_GALARIAN] = _("GalarArticuno"),
    [SPECIES_ZAPDOS_GALARIAN] = _("Galar Zapdos"),
    [SPECIES_MOLTRES_GALARIAN] = _("Galar Moltres"),
    [SPECIES_SLOWKING_GALARIAN] = _("GalarSlowking"),
    [SPECIES_CORSOLA_GALARIAN] = _("Galar Corsola"),
    [SPECIES_ZIGZAGOON_GALARIAN] = _("GalarZigzagon"),
    [SPECIES_LINOONE_GALARIAN] = _("Galar Linoone"),
    [SPECIES_DARUMAKA_GALARIAN] = _("GalarDarumaka"),
    [SPECIES_DARMANITAN_GALARIAN] = _("GalarDarmantn"),
    [SPECIES_YAMASK_GALARIAN] = _("Galar Yamask"),
    [SPECIES_STUNFISK_GALARIAN] = _("GalarStunfisk"),

    // Cosplay Pikachu
    [SPECIES_PIKACHU_COSPLAY] = _("PlayPikachu"),
    [SPECIES_PIKACHU_ROCK_STAR] = _("RockPikachu"),
    [SPECIES_PIKACHU_BELLE] = _("Belle Pikachu"),
    [SPECIES_PIKACHU_POP_STAR] = _("PopPikachu"),
    [SPECIES_PIKACHU_PH_D] = _("PhD Pikachu"),
    [SPECIES_PIKACHU_LIBRE] = _("Libre Pikachu"),
    // Cap Pikachu
    [SPECIES_PIKACHU_ORIGINAL_CAP] = _("OriginPikachu"),
    [SPECIES_PIKACHU_HOENN_CAP] = _("Hoenn Pikachu"),
    [SPECIES_PIKACHU_SINNOH_CAP] = _("SinnohPikachu"),
    [SPECIES_PIKACHU_UNOVA_CAP] = _("Unova Pikachu"),
    [SPECIES_PIKACHU_KALOS_CAP] = _("Kalos Pikachu"),
    [SPECIES_PIKACHU_ALOLA_CAP] = _("Alola Pikachu"),
    [SPECIES_PIKACHU_PARTNER_CAP] = _("Pal Pikachu"),
    [SPECIES_PIKACHU_WORLD_CAP] = _("World Pikachu"),
    // Pichu
    [SPECIES_PICHU_SPIKY_EARED] = _("SpikyEarPichu"),
    // Unown
    ...
    // Castform
    [SPECIES_CASTFORM_SUNNY] = _("CastformSunny"),
    [SPECIES_CASTFORM_RAINY] = _("CastformRainy"),
    [SPECIES_CASTFORM_SNOWY] = _("CastformSnowy"),
    // Deoxys
    [SPECIES_DEOXYS_ATTACK] = _("Deoxys Attack"),
    [SPECIES_DEOXYS_DEFENSE] = _("DeoxysDefense"),
    ...
    [SPECIES_WORMADAM_TRASH_CLOAK] = _("WormadamTrash"),
    // Cherrim
    [SPECIES_CHERRIM_SUNSHINE] = _("CherrimSun"),
    // Shellos
    [SPECIES_SHELLOS_EAST_SEA] = _("Shellos East"),
    // Gastrodon
    [SPECIES_GASTRODON_EAST_SEA] = _("GastrodonEast"),
    // Rotom
    ...
    // Giratina
    [SPECIES_GIRATINA_ORIGIN] = _("GiratinaOrign"),
    // Shaymin
    [SPECIES_SHAYMIN_SKY] = _("Shaymin Sky"),
    // Arceus
    [SPECIES_ARCEUS_FIGHTING] = _("Arceus Fight"),
    ...
    [SPECIES_ARCEUS_ELECTRIC] = _("Arceus Electk"),
    [SPECIES_ARCEUS_PSYCHIC] = _("ArceusPsychic"),
    ...
    // Darmanitan
    [SPECIES_DARMANITAN_ZEN_MODE] = _("DarmanitanZen"),
    [SPECIES_DARMANITAN_ZEN_MODE_GALARIAN] = _("GDarmanitnZen"),
    // Deerling
    [SPECIES_DEERLING_SUMMER] = _("Deerling Su"),
    [SPECIES_DEERLING_AUTUMN] = _("Deerling Fall"),
    [SPECIES_DEERLING_WINTER] = _("Deerling W"),
    // Sawsbuck
    [SPECIES_SAWSBUCK_SUMMER] = _("Sawsbuck Su"),
    [SPECIES_SAWSBUCK_AUTUMN] = _("Sawsbuck Fall"),
    [SPECIES_SAWSBUCK_WINTER] = _("Sawsbuck W"),
    // Therian Forms
    [SPECIES_TORNADUS_THERIAN] = _("Tornadus Ther"),
    [SPECIES_THUNDURUS_THERIAN] = _("Thundurs Ther"),
    [SPECIES_LANDORUS_THERIAN] = _("Landorus Ther"),
    // Kyurem
    [SPECIES_KYUREM_BLACK] = _("Kyurem Black"),
    [SPECIES_KYUREM_WHITE] = _("Kyurem White"),
    // Keldeo
    [SPECIES_KELDEO_RESOLUTE] = _("KeldeoResolut"),
    // Meloetta
    [SPECIES_MELOETTA_PIROUETTE] = _("MeloettaDance"),
    // Genesect
    [SPECIES_GENESECT_DOUSE_DRIVE] = _("GenesectDouse"),
    [SPECIES_GENESECT_SHOCK_DRIVE] = _("GenesectShock"),
    [SPECIES_GENESECT_BURN_DRIVE] = _("Genesect Burn"),
    [SPECIES_GENESECT_CHILL_DRIVE] = _("GenesectChill"),
    // Greninja
    [SPECIES_GRENINJA_BATTLE_BOND] = _("Greninja Bond"),
    [SPECIES_GRENINJA_ASH] = _("Ash Greninja"),
    // Vivillon
    [SPECIES_VIVILLON_POLAR] = _("VivillonPolar"),
    [SPECIES_VIVILLON_TUNDRA] = _("VivilonTundra"),
    [SPECIES_VIVILLON_CONTINENTAL] = _("VivillonLand"),
    [SPECIES_VIVILLON_GARDEN] = _("VivilonGarden"),
    [SPECIES_VIVILLON_ELEGANT] = _("VivilonElegnt"),
    [SPECIES_VIVILLON_MEADOW] = _("VivilonMeadow"),
    [SPECIES_VIVILLON_MODERN] = _("VivilonModern"),
    [SPECIES_VIVILLON_MARINE] = _("VivilonMarine"),
    [SPECIES_VIVILLON_ARCHIPELAGO] = _("VivilonIsland"),
    [SPECIES_VIVILLON_HIGH_PLAINS] = _("VivilonPlains"),
    [SPECIES_VIVILLON_SANDSTORM] = _("VivillonSand"),
    [SPECIES_VIVILLON_RIVER] = _("VivillonRiver"),
    [SPECIES_VIVILLON_MONSOON] = _("VivilonMonson"),
    [SPECIES_VIVILLON_SAVANNA] = _("VivilonSavana"),
    [SPECIES_VIVILLON_SUN] = _("VivillonSun"),
    [SPECIES_VIVILLON_OCEAN] = _("VivillonOcean"),
    [SPECIES_VIVILLON_JUNGLE] = _("VivilonJungle"),
    [SPECIES_VIVILLON_FANCY] = _("VivillonFancy"),
    [SPECIES_VIVILLON_POKE_BALL] = _("VivillonBall"),
    // Flabébé
    [SPECIES_FLABEBE_YELLOW_FLOWER] = _("Flabébé Y"),
    [SPECIES_FLABEBE_ORANGE_FLOWER] = _("Flabébé O"),
    [SPECIES_FLABEBE_BLUE_FLOWER] = _("Flabébé B"),
    [SPECIES_FLABEBE_WHITE_FLOWER] = _("Flabébé W"),
    // Floette
    [SPECIES_FLOETTE_YELLOW_FLOWER] = _("FloetteYellow"),
    [SPECIES_FLOETTE_ORANGE_FLOWER] = _("FloetteOrange"),
    [SPECIES_FLOETTE_BLUE_FLOWER] = _("Floette Blue"),
    [SPECIES_FLOETTE_WHITE_FLOWER] = _("Floette White"),
    [SPECIES_FLOETTE_ETERNAL_FLOWER] = _("FloeteEternal"),
    // Florges
    [SPECIES_FLORGES_YELLOW_FLOWER] = _("FlorgesYellow"),
    [SPECIES_FLORGES_ORANGE_FLOWER] = _("FlorgesOrange"),
    [SPECIES_FLORGES_BLUE_FLOWER] = _("Florges Blue"),
    [SPECIES_FLORGES_WHITE_FLOWER] = _("Florges White"),
    // Furfrou
    [SPECIES_FURFROU_HEART_TRIM] = _("Furfrou Heart"),
    [SPECIES_FURFROU_STAR_TRIM] = _("Furfrou Star"),
    [SPECIES_FURFROU_DIAMOND_TRIM] = _("FurfrouDiamnd"),
    [SPECIES_FURFROU_DEBUTANTE_TRIM] = _("FurfroDebutnt"),
    [SPECIES_FURFROU_MATRON_TRIM] = _("FurfrouMatron"),
    [SPECIES_FURFROU_DANDY_TRIM] = _("Furfrou Dandy"),
    [SPECIES_FURFROU_LA_REINE_TRIM] = _("FurfrouLaRein"),
    [SPECIES_FURFROU_KABUKI_TRIM] = _("FurfrouKabuki"),
    [SPECIES_FURFROU_PHARAOH_TRIM] = _("FurfrouPharoh"),
    // Meowstic
    [SPECIES_MEOWSTIC_FEMALE] = _("Meowstic F"),
    // Aegislash
    [SPECIES_AEGISLASH_BLADE] = _("Aegislash"),
    // Pumpkaboo
    [SPECIES_PUMPKABOO_SMALL] = _("PumpkaboSmall"),
    [SPECIES_PUMPKABOO_LARGE] = _("PumpkaboLarge"),
    [SPECIES_PUMPKABOO_SUPER] = _("PumpkaboSuper"),
    // Gourgeist
    [SPECIES_GOURGEIST_SMALL] = _("GorgeistSmall"),
    [SPECIES_GOURGEIST_LARGE] = _("GorgeistLarge"),
    [SPECIES_GOURGEIST_SUPER] = _("GorgeistSuper"),
    // Xerneas
    [SPECIES_XERNEAS_ACTIVE] = _("XerneasActive"),
    // Zygarde
    ...
    [SPECIES_ZYGARDE_COMPLETE] = _("ZygardComplet"),
    // Hoopa
    [SPECIES_HOOPA_UNBOUND] = _("Hoopa Unbound"),
    // Oricorio
    [SPECIES_ORICORIO_POM_POM] = _("OricoroPomPom"),
    [SPECIES_ORICORIO_PAU] = _("Oricorio Pau"),
    [SPECIES_ORICORIO_SENSU] = _("OricorioSensu"),
    // Rockruff
    [SPECIES_ROCKRUFF_OWN_TEMPO] = _("RockruffTempo"),
    // Lycanroc
    [SPECIES_LYCANROC_MIDNIGHT] = _("LycanrocNight"),
    [SPECIES_LYCANROC_DUSK] = _("Lycanroc Dusk"),
    // Wishiwashi
    [SPECIES_WISHIWASHI_SCHOOL] = _("Wishiwashi"),
    // Silvally
    [SPECIES_SILVALLY_FIGHTING] = _("SilvallyFight"),
    [SPECIES_SILVALLY_FLYING] = _("Silvally Fly"),
    [SPECIES_SILVALLY_POISON] = _("SilvalyPoison"),
    [SPECIES_SILVALLY_GROUND] = _("SilvalyGround"),
    [SPECIES_SILVALLY_ROCK] = _("Silvally Rock"),
    [SPECIES_SILVALLY_BUG] = _("Silvally Bug"),
    [SPECIES_SILVALLY_GHOST] = _("SilvallyGhost"),
    [SPECIES_SILVALLY_STEEL] = _("SilvallySteel"),
    [SPECIES_SILVALLY_FIRE] = _("Silvally Fire"),
    [SPECIES_SILVALLY_WATER] = _("SilvallyWater"),
    [SPECIES_SILVALLY_GRASS] = _("SilvallyGrass"),
    [SPECIES_SILVALLY_ELECTRIC] = _("Silvaly Elek"),
    [SPECIES_SILVALLY_PSYCHIC] = _("Silvaly Psych"),
    [SPECIES_SILVALLY_ICE] = _("Silvally Ice"),
    [SPECIES_SILVALLY_DRAGON] = _("SilvalyDragon"),
    [SPECIES_SILVALLY_DARK] = _("Silvally Dark"),
    ...
    [SPECIES_NECROZMA_ULTRA] = _("NecrozmaUltra"),
    // Magearna
    ...
    // Toxtricity
    [SPECIES_TOXTRICITY_LOW_KEY] = _("ToxtricityLow"),
    // Sinistea
    [SPECIES_SINISTEA_ANTIQUE] = _("SinisteaAntiq"),
    // Polteageist
    [SPECIES_POLTEAGEIST_ANTIQUE] = _("PoltegisAntiq"),
    // Alcremie
    [SPECIES_ALCREMIE_RUBY_CREAM] = _("Alcremie Ruby"),
    [SPECIES_ALCREMIE_MATCHA_CREAM] = _("AlcremieMacha"),
    [SPECIES_ALCREMIE_MINT_CREAM] = _("Alcremie Mint"),
    [SPECIES_ALCREMIE_LEMON_CREAM] = _("AlcremieLemon"),
    [SPECIES_ALCREMIE_SALTED_CREAM] = _("AlcremieSalt"),
    [SPECIES_ALCREMIE_RUBY_SWIRL] = _("AlcremieSwirl"),
    [SPECIES_ALCREMIE_CARAMEL_SWIRL] = _("AlcremiCaraml"),
    [SPECIES_ALCREMIE_RAINBOW_SWIRL] = _("AlcremiRainbw"),
    // Eiscue
    ...
    // Zacian
    [SPECIES_ZACIAN_CROWNED_SWORD] = _("Zacian Crown"),
    // Zamazenta
    [SPECIES_ZAMAZENTA_CROWNED_SHIELD] = _("ZamzentaCrown"),
    // Eternatus
    ...
    [SPECIES_CALYREX_SHADOW_RIDER] = _("CalyrexShadow"),
};
