const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_VIVILLON] = _("Vivillon Icy Snow"),
    ...
    [SPECIES_PUMPKABOO] = _("Pumpkaboo Average"),
    [SPECIES_GOURGEIST] = _("Gourgeist Average"),
    [SPECIES_BERGMITE] = _("Bergmite Average"),
    ...
    [SPECIES_TOXTRICITY] = _("Toxtricity Amped"),
    ...
    [SPECIES_CHARIZARD_MEGA_X] = _("Mega Charizard X"),
    [SPECIES_CHARIZARD_MEGA_Y] = _("Mega Charizard Y"),
    [SPECIES_BLASTOISE_MEGA] = _("Mega Blastoise"),
    ...
    [SPECIES_KANGASKHAN_MEGA] = _("Mega Kangaskhan"),
    [SPECIES_PINSIR_MEGA] = _("Mega Pinsir"),
    [SPECIES_GYARADOS_MEGA] = _("Mega Gyarados"),
    [SPECIES_AERODACTYL_MEGA] = _("Mega Aerodactyl"),
    ...
    [SPECIES_MANECTRIC_MEGA] = _("Mega Manectric"),
    ...
    [SPECIES_METAGROSS_MEGA] = _("Mega Metagross"),
    ...
    [SPECIES_ABOMASNOW_MEGA] = _("Mega Abomasnow"),
    ...
    [SPECIES_BUTTERFREE_MEGA] = _("Mega Butterfree"),
    ...
    [SPECIES_SANDSHREW_ALOLAN] = _("Alolan Sandshrew"),
    [SPECIES_SANDSLASH_ALOLAN] = _("Alolan Sandslash"),
    [SPECIES_VULPIX_ALOLAN] = _("Alolan Vulpix"),
    [SPECIES_NINETALES_ALOLAN] = _("Alolan Ninetales"),
    [SPECIES_DIGLETT_ALOLAN] = _("Alolan Diglett"),
    [SPECIES_DUGTRIO_ALOLAN] = _("Alolan Dugtrio"),
    [SPECIES_MEOWTH_ALOLAN] = _("Alolan Meowth"),
    [SPECIES_PERSIAN_ALOLAN] = _("Alolan Persian"),
    [SPECIES_GEODUDE_ALOLAN] = _("Alolan Geodude"),
    [SPECIES_GRAVELER_ALOLAN] = _("Alolan Graveler"),
    [SPECIES_GOLEM_ALOLAN] = _("Alolan Golem"),
    [SPECIES_GRIMER_ALOLAN] = _("Alolan Grimer"),
    [SPECIES_MUK_ALOLAN] = _("Alolan Muk"),
    [SPECIES_EXEGGUTOR_ALOLAN] = _("Alolan Exeggutor"),
    [SPECIES_MAROWAK_ALOLAN] = _("Alolan Marowak"),

    // Galarian Forms
    [SPECIES_MEOWTH_GALARIAN] = _("Galarian Meowth"),
    [SPECIES_PONYTA_GALARIAN] = _("Galarian Ponyta"),
    [SPECIES_RAPIDASH_GALARIAN] = _("Galarian Rapidash"),
    [SPECIES_SLOWPOKE_GALARIAN] = _("Galarian Slowpoke"),
    [SPECIES_SLOWBRO_GALARIAN] = _("Galarian Slowbro"),
    [SPECIES_FARFETCHD_GALARIAN] = _("Galarian Farfetch'd"),
    [SPECIES_WEEZING_GALARIAN] = _("Galarian Weezing"),
    [SPECIES_MR_MIME_GALARIAN] = _("Galarian Mr. Mime"),
    [SPECIES_ARTICUNO_GALARIAN] = _("Galarian Articuno"),
    [SPECIES_ZAPDOS_GALARIAN] = _("Galarian Zapdos"),
    [SPECIES_MOLTRES_GALARIAN] = _("Galarian Moltres"),
    [SPECIES_SLOWKING_GALARIAN] = _("Galarian Slowking"),
    [SPECIES_CORSOLA_GALARIAN] = _("Galarian Corsola"),
    [SPECIES_ZIGZAGOON_GALARIAN] = _("Galarian Zigzagoon"),
    [SPECIES_LINOONE_GALARIAN] = _("Galarian Linoone"),
    [SPECIES_DARUMAKA_GALARIAN] = _("Galarian Darumaka"),
    [SPECIES_DARMANITAN_GALARIAN] = _("Galarian Darmanitan"),
    [SPECIES_YAMASK_GALARIAN] = _("Galarian Yamask"),
    [SPECIES_STUNFISK_GALARIAN] = _("Galarian Stunfisk"),

    // Cosplay Pikachu
    [SPECIES_PIKACHU_COSPLAY] = _("Cosplay Pikachu"),
    [SPECIES_PIKACHU_ROCK_STAR] = _("Rock Star Pikachu"),
    [SPECIES_PIKACHU_BELLE] = _("Belle Pikachu"),
    [SPECIES_PIKACHU_POP_STAR] = _("Pop Star Pikachu"),
    [SPECIES_PIKACHU_PH_D] = _("PhD Pikachu"),
    [SPECIES_PIKACHU_LIBRE] = _("Libre Pikachu"),
    // Cap Pikachu
    [SPECIES_PIKACHU_ORIGINAL_CAP] = _("Original Cap Pikachu"),
    [SPECIES_PIKACHU_HOENN_CAP] = _("Hoenn Cap Pikachu"),
    [SPECIES_PIKACHU_SINNOH_CAP] = _("Sinnoh Cap Pikachu"),
    [SPECIES_PIKACHU_UNOVA_CAP] = _("Unova Cap Pikachu"),
    [SPECIES_PIKACHU_KALOS_CAP] = _("Kalos Cap Pikachu"),
    [SPECIES_PIKACHU_ALOLA_CAP] = _("Alola Cap Pikachu"),
    [SPECIES_PIKACHU_PARTNER_CAP] = _("Partner Cap Pikachu"),
    [SPECIES_PIKACHU_WORLD_CAP] = _("World Cap Pikachu"),
    // Pichu
    [SPECIES_PICHU_SPIKY_EARED] = _("Skiky Eared Pichu"),
    // Unown
    ...
    // Cherrim
    [SPECIES_CHERRIM_SUNSHINE] = _("Cherrim Sunshine"),
    // Shellos
    [SPECIES_SHELLOS_EAST_SEA] = _("Shellos East Sea"),
    // Gastrodon
    [SPECIES_GASTRODON_EAST_SEA] = _("Gastrodon East Sea"),
    // Rotom
    ...
    [SPECIES_DARMANITAN_ZEN_MODE_GALARIAN] = _("Galarian Darmanitan Zen"),
    // Deerling
    ...
    // Therian Forms
    [SPECIES_TORNADUS_THERIAN] = _("Tornadus Therian"),
    [SPECIES_THUNDURUS_THERIAN] = _("Thundurus Therian"),
    [SPECIES_LANDORUS_THERIAN] = _("Landorus Therian"),
    // Kyurem
    ...
    // Meloetta
    [SPECIES_MELOETTA_PIROUETTE] = _("Meloetta Pirouette"),
    // Genesect
    ...
    // Greninja
    [SPECIES_GRENINJA_BATTLE_BOND] = _("Greninja Battle Bond"),
    [SPECIES_GRENINJA_ASH] = _("Ash Greninja"),
    // Vivillon
    [SPECIES_VIVILLON_POLAR] = _("Vivillon Polar"),
    [SPECIES_VIVILLON_TUNDRA] = _("Vivillon Tundra"),
    [SPECIES_VIVILLON_CONTINENTAL] = _("Vivillon Continental"),
    [SPECIES_VIVILLON_GARDEN] = _("Vivillon Garden"),
    [SPECIES_VIVILLON_ELEGANT] = _("Vivillon Elegant"),
    [SPECIES_VIVILLON_MEADOW] = _("Vivillon Meadow"),
    [SPECIES_VIVILLON_MODERN] = _("Vivillon Modern"),
    [SPECIES_VIVILLON_MARINE] = _("Vivillon Marine"),
    [SPECIES_VIVILLON_ARCHIPELAGO] = _("Vivillon Archipelago"),
    [SPECIES_VIVILLON_HIGH_PLAINS] = _("Vivillon High Plains"),
    [SPECIES_VIVILLON_SANDSTORM] = _("Vivillon Sandstorm"),
    [SPECIES_VIVILLON_RIVER] = _("Vivillon River"),
    [SPECIES_VIVILLON_MONSOON] = _("Vivillon Monsoon"),
    [SPECIES_VIVILLON_SAVANNA] = _("Vivillon Savanna"),
    [SPECIES_VIVILLON_SUN] = _("Vivillon Sun"),
    [SPECIES_VIVILLON_OCEAN] = _("Vivillon Ocean"),
    [SPECIES_VIVILLON_JUNGLE] = _("Vivillon Jungle"),
    [SPECIES_VIVILLON_FANCY] = _("Vivillon Fancy"),
    [SPECIES_VIVILLON_POKE_BALL] = _("Vivillon Poke Ball"),
    // Flabébé
    ...
    [SPECIES_FURFROU_DIAMOND_TRIM] = _("Furfrou Diamond"),
    [SPECIES_FURFROU_DEBUTANTE_TRIM] = _("Furfrou Debutante"),
    [SPECIES_FURFROU_MATRON_TRIM] = _("Furfrou Matron"),
    [SPECIES_FURFROU_DANDY_TRIM] = _("Furfrou Dandy"),
    [SPECIES_FURFROU_LA_REINE_TRIM] = _("Furfrou La Reine"),
    [SPECIES_FURFROU_KABUKI_TRIM] = _("Furfrou Kabuki"),
    [SPECIES_FURFROU_PHARAOH_TRIM] = _("Furfrou Pharaoh"),
    // Meowstic
    [SPECIES_MEOWSTIC_FEMALE] = _("Meowstic F"),
    // Aegislash
    [SPECIES_AEGISLASH_BLADE] = _("Aegislash"),
    // Pumpkaboo
    [SPECIES_PUMPKABOO_SMALL] = _("Pumpkaboo Small"),
    [SPECIES_PUMPKABOO_LARGE] = _("Pumpkaboo Large"),
    [SPECIES_PUMPKABOO_SUPER] = _("Pumpkaboo Super"),
    // Gourgeist
    [SPECIES_GOURGEIST_SMALL] = _("Gourgeist Small"),
    [SPECIES_GOURGEIST_LARGE] = _("Gourgeist Large"),
    [SPECIES_GOURGEIST_SUPER] = _("Gourgeist Super"),
    // Xerneas
    [SPECIES_XERNEAS_ACTIVE] = _("Xerneas Active"),
    // Zygarde
    [SPECIES_ZYGARDE_10] = _("Zygarde 10"),
    [SPECIES_ZYGARDE_10_POWER_CONSTRUCT] = _("Zygarde 10 Construct"),
    [SPECIES_ZYGARDE_50_POWER_CONSTRUCT] = _("Zygarde Construct"),
    [SPECIES_ZYGARDE_COMPLETE] = _("Zygarde Complete"),
    // Hoopa
    [SPECIES_HOOPA_UNBOUND] = _("Hoopa Unbound"),
    // Oricorio
    [SPECIES_ORICORIO_POM_POM] = _("Oricorio Pom Pom"),
    [SPECIES_ORICORIO_PAU] = _("Oricorio Pau"),
    [SPECIES_ORICORIO_SENSU] = _("Oricorio Sensu"),
    // Rockruff
    [SPECIES_ROCKRUFF_OWN_TEMPO] = _("Rockruff Tempo"),
    // Lycanroc
    [SPECIES_LYCANROC_MIDNIGHT] = _("Lycanroc Midnight"),
    [SPECIES_LYCANROC_DUSK] = _("Lycanroc Dusk"),
    // Wishiwashi
    [SPECIES_WISHIWASHI_SCHOOL] = _("Wishiwashi School"),
    // Silvally
    [SPECIES_SILVALLY_FIGHTING] = _("Silvally Fighting"),
    [SPECIES_SILVALLY_FLYING] = _("Silvally Flying"),
    [SPECIES_SILVALLY_POISON] = _("Silvally Poison"),
    [SPECIES_SILVALLY_GROUND] = _("Silvally Ground"),
    [SPECIES_SILVALLY_ROCK] = _("Silvally Rock"),
    [SPECIES_SILVALLY_BUG] = _("Silvally Bug"),
    [SPECIES_SILVALLY_GHOST] = _("Silvally Ghost"),
    [SPECIES_SILVALLY_STEEL] = _("Silvally Steel"),
    [SPECIES_SILVALLY_FIRE] = _("Silvally Fire"),
    [SPECIES_SILVALLY_WATER] = _("Silvally Water"),
    [SPECIES_SILVALLY_GRASS] = _("Silvally Grass"),
    [SPECIES_SILVALLY_ELECTRIC] = _("Silvally Electric"),
    [SPECIES_SILVALLY_PSYCHIC] = _("Silvally Psychic"),
    [SPECIES_SILVALLY_ICE] = _("Silvally Ice"),
    [SPECIES_SILVALLY_DRAGON] = _("Silvally Dragon"),
    [SPECIES_SILVALLY_DARK] = _("Silvally Dark"),
    [SPECIES_SILVALLY_FAIRY] = _("Silvally Fairy"),
    // Minior
    ...
    // Magearna
    [SPECIES_MAGEARNA_ORIGINAL_COLOR] = _("Magearna Original"),
    // Cramorant
    ...
    // Sinistea
    [SPECIES_SINISTEA_ANTIQUE] = _("Sinistea Antique"),
    // Polteageist
    [SPECIES_POLTEAGEIST_ANTIQUE] = _("Polteageis Antique"),
    // Alcremie
    [SPECIES_ALCREMIE_RUBY_CREAM] = _("Alcremie Ruby Cream"),
    [SPECIES_ALCREMIE_MATCHA_CREAM] = _("Alcremie Matcha Cream"),
    [SPECIES_ALCREMIE_MINT_CREAM] = _("Alcremie Mint Cream"),
    [SPECIES_ALCREMIE_LEMON_CREAM] = _("Alcremie Lemon Cream"),
    [SPECIES_ALCREMIE_SALTED_CREAM] = _("Alcremie Salted Cream"),
    [SPECIES_ALCREMIE_RUBY_SWIRL] = _("Alcremie Ruby Swirl"),
    [SPECIES_ALCREMIE_CARAMEL_SWIRL] = _("Alcremie Caramel Swirl"),
    [SPECIES_ALCREMIE_RAINBOW_SWIRL] = _("Alcremie Rainbow Swirl"),
    // Eiscue
    ...
    // Zacian
    [SPECIES_ZACIAN_CROWNED_SWORD] = _("Zacian Crowned"),
    // Zamazenta
    [SPECIES_ZAMAZENTA_CROWNED_SHIELD] = _("Zamazenta Crowned"),
    // Eternatus
    [SPECIES_ETERNATUS_ETERNAMAX] = _("Eternmax Eternatus"),
    // Urshifu
    [SPECIES_URSHIFU_RAPID_STRIKE_STYLE] = _("Rapid Strike Urshifu"),
    // Zarude
    [SPECIES_ZARUDE_DADA] = _("Zarude Dada"),
    // Calyrex
    [SPECIES_CALYREX_ICE_RIDER] = _("Calyrex Ice Rider"),
    [SPECIES_CALYREX_SHADOW_RIDER] = _("Calyrex Shadow Rider"),
};
