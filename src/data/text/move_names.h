...
const u8 gMoveNamesLong[MOVES_COUNT][LONG_MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_ALPHA_STRIKE] = _("Totem Bash"),
    [MOVE_SHADOW_MAKER] = _("Totem Bash"),
    [MOVE_TOTEM_QUAKE] = _("Totem Bash"),
    [MOVE_ALPHA_RAGE] = _("Totem Bash"),
    [MOVE_GMAX_ENERGY] = _("Totem Bash"),
    [MOVE_GRAVES_SHADOW] = _("Totem Bash"),
    [MOVE_PRIMAL_POWER] = _("Totem Bash"),
    [MOVE_DOOMED_TOTEM] = _("Totem Bash"),
    [MOVE_ALPHA_DOMINANCE] = _("Totem Bash"),
    [MOVE_GMAX_BURST] = _("Totem Bash"),
    [MOVE_SHADOW_REAPER] = _("Totem Bash"),
    [MOVE_PRIMORDIAL_POWER] = _("Totem Bash"),
};
