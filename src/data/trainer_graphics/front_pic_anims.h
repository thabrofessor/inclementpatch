...
static const union AnimCmd *const sAnims_Wes[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_Shady[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_Fans[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Karen[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Hoopstar[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Linebacker[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Rockstar[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Starlet[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Gem[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Arch[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_Chad[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_Ghetsis[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Lysander[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_Birch[] ={
    sAnim_GeneralFrame0,
};
        ...
        [TRAINER_PIC_WES] = sAnims_Wes,
            ...
            [TRAINER_PIC_YELLOW] = sAnims_Yellow,
                [TRAINER_PIC_SHADY] = sAnims_Shady,
                  ...
                  [TRAINER_PIC_THIEF] = sAnims_Thief,
                      ...
                      [TRAINER_PIC_THORTON] = sAnims_Thorton,
                          [TRAINER_PIC_CYRUS] = sAnims_Cyrus,
                              ...
                              [TRAINER_PIC_STARLET] = sAnims_Starlet,
                                  [TRAINER_PIC_GEM] = sAnims_Gem,
                                  [TRAINER_PIC_ARCH] = sAnims_Arch,
                                  [TRAINER_PIC_COLE] = sAnims_Cole,
                                  [TRAINER_PIC_CHAD] = sAnims_Chad,
                                  ...
                                  [TRAINER_PIC_LYSANDER] = sAnims_Lysander,
                                      [TRAINER_PIC_LUSAMINE] = sAnims_Lusamine,
                                      [TRAINER_PIC_WILL] = sAnims_Will,
                                      [TRAINER_PIC_N] = sAnims_N,
                                      [TRAINER_PIC_GUZMA] = sAnims_Guzma,
                                      [TRAINER_PIC_SCOTT] = sAnims_Scott,
                                      [TRAINER_PIC_JENNY] = sAnims_Jenny,
                                      [TRAINER_PIC_JOY] = sAnims_Joy,
                                      [TRAINER_PIC_ROCKETM] = sAnims_Rocketm,
                                      [TRAINER_PIC_ROCKETF] = sAnims_Rocketf,
                                      [TRAINER_PIC_PLASMAM] = sAnims_Plasmam,
                                      [TRAINER_PIC_PLASMAF] = sAnims_Plasmaf,
                                      [TRAINER_PIC_GALACTICM] = sAnims_Galacticm,
                                      [TRAINER_PIC_GALACTICF] = sAnims_Galacticf,
                                      [TRAINER_PIC_HISTORIAN] = sAnims_Historian,
                                      [TRAINER_PIC_PRES] = sAnims_Pres,
                                      [TRAINER_PIC_SAGEM] = sAnims_Sagem,
                                      [TRAINER_PIC_SAGEF] = sAnims_Sagef,
                                      [TRAINER_PIC_COOLTM] = sAnims_Cooltm,
                                      [TRAINER_PIC_COOLTF] = sAnims_Cooltf,
                                          [TRAINER_PIC_BIRCH] = sAnims_Birch,
};
