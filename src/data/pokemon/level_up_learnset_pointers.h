const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    // Vivillon
    [SPECIES_VIVILLON_POLAR] = sVivillonPOLARLevelUpLearnset,
    [SPECIES_VIVILLON_TUNDRA] = sVivillonTUNDRALevelUpLearnset,
    [SPECIES_VIVILLON_CONTINENTAL] = sVivillonCONTINENTALLevelUpLearnset,
    [SPECIES_VIVILLON_GARDEN] = sVivillonGARDENLevelUpLearnset,
    [SPECIES_VIVILLON_ELEGANT] = sVivillonELEGANTLevelUpLearnset,
    [SPECIES_VIVILLON_MEADOW] = sVivillonMEADOWLevelUpLearnset,
    [SPECIES_VIVILLON_MODERN] = sVivillonMODERNLevelUpLearnset,
    [SPECIES_VIVILLON_MARINE] = sVivillonMARINELevelUpLearnset,
    [SPECIES_VIVILLON_ARCHIPELAGO] = sVivillonARCHIPELAGOLevelUpLearnset,
    [SPECIES_VIVILLON_HIGH_PLAINS] = sVivillonHIGHPLAINSLevelUpLearnset,
    [SPECIES_VIVILLON_SANDSTORM] = sVivillonSANDSTORMLevelUpLearnset,
    [SPECIES_VIVILLON_RIVER] = sVivillonRIVERLevelUpLearnset,
    [SPECIES_VIVILLON_MONSOON] = sVivillonMONSOONLevelUpLearnset,
    [SPECIES_VIVILLON_SAVANNA] = sVivillonSAVANNALevelUpLearnset,
    [SPECIES_VIVILLON_SUN] = sVivillonSUNLevelUpLearnset,
    [SPECIES_VIVILLON_OCEAN] = sVivillonOCEANLevelUpLearnset,
    [SPECIES_VIVILLON_JUNGLE] = sVivillonJUNGLELevelUpLearnset,
    [SPECIES_VIVILLON_FANCY] = sVivillonFANCYLevelUpLearnset,
    [SPECIES_VIVILLON_POKE_BALL] = sVivillonPOKEBALLLevelUpLearnset,
    // Flabébé
    ...
    [SPECIES_FURFROU_STAR_TRIM] = sFurfrouStarLevelUpLearnset,
    [SPECIES_FURFROU_DIAMOND_TRIM] = sFurfrouDIAMONDLevelUpLearnset,
    [SPECIES_FURFROU_DEBUTANTE_TRIM] = sFurfrouDEBUTANTELevelUpLearnset,
    [SPECIES_FURFROU_MATRON_TRIM] = sFurfrouMATRONLevelUpLearnset,
    [SPECIES_FURFROU_DANDY_TRIM] = sFurfrouDANDYLevelUpLearnset,
    [SPECIES_FURFROU_LA_REINE_TRIM] = sFurfrouLAREINELevelUpLearnset,
    [SPECIES_FURFROU_KABUKI_TRIM] = sFurfrouKABUKILevelUpLearnset,
    [SPECIES_FURFROU_PHARAOH_TRIM] = sFurfrouPHARAOHLevelUpLearnset,
    // Meowstic
...
[SPECIES_BASCULEGION_MALE] = sBasculegionMaleLevelUpLearnset,
...
[SPECIES_MAUSHOLD_THREE] = sMausholdThreeLevelUpLearnset,
[SPECIES_MAUSHOLD_FOUR] = sMausholdFourLevelUpLearnset,
...
[SPECIES_SQUAWKABILLY_GREEN] = sSquawkabillyGreenLevelUpLearnset,
[SPECIES_SQUAWKABILLY_BLUE] = sSquawkabillyBlueLevelUpLearnset,
[SPECIES_SQUAWKABILLY_YELLOW] = sSquawkabillyYellowLevelUpLearnset,
[SPECIES_SQUAWKABILLY_WHITE] = sSquawkabillyWhiteLevelUpLearnset,
...
[SPECIES_PALAFIN_ZERO] = sPalafinZeroLevelUpLearnset,
...
[SPECIES_TATSUGIRI_CURLY] = sTatsugiriCurlyLevelUpLearnset,
[SPECIES_TATSUGIRI_DROOPY] = sTatsugiriDroopyLevelUpLearnset,
[SPECIES_TATSUGIRI_STRETCHY] = sTatsugiriStretchyLevelUpLearnset,
...
[SPECIES_GIMMIGHOUL_CHEST] = sGimmighoulChestLevelUpLearnset,
[SPECIES_GIMMIGHOUL_ROAMING] = sGimmighoulRoamingLevelUpLearnset,
...
[SPECIES_POLTCHAGEIST_COUNTERFEIT] = sPoltchageistCounterfeitLevelUpLearnset,
[SPECIES_POLTCHAGEIST_ARTISAN] = sPoltchageistArtisanLevelUpLearnset,
[SPECIES_SINISTCHA_UNREMARKABLE] = sSinistchaUnremarkableLevelUpLearnset,
[SPECIES_SINISTCHA_MASTERPIECE] = sSinistchaMasterpieceLevelUpLearnset,
...
[SPECIES_OGERPON_TEAL] = sOgerponTealLevelUpLearnset,
[SPECIES_OGERPON_WELLSPRING] = sOgerponWellspringLevelUpLearnset,
[SPECIES_OGERPON_HEARTHFLAME] = sOgerponHearthflameLevelUpLearnset,
[SPECIES_OGERPON_CORNERSTONE] = sOgerponCornerstoneLevelUpLearnset,
[SPECIES_OGERPON_TEAL_MASK_TERA] = sOgerponTealMaskTeraLevelUpLearnset,
[SPECIES_OGERPON_WELLSPRING_MASK_TERA] = sOgerponWellspringMaskTeraLevelUpLearnset,
[SPECIES_OGERPON_HEARTHFLAME_MASK_TERA] = sOgerponHearthflameMaskTeraLevelUpLearnset,
[SPECIES_OGERPON_CORNERSTONE_MASK_TERA] = sOgerponCornerstoneMaskTeraLevelUpLearnset,
[SPECIES_URSALUNA_BLOODMOON] = sUrsalunaBloodmoonLevelUpLearnset,
[SPECIES_MOTHIM_SANDY_CLOAK] = sMothimSandyCloakLevelUpLearnset,
[SPECIES_MOTHIM_TRASH_CLOAK] = sMothimTrashCloakLevelUpLearnset,
[SPECIES_SCATTERBUG_POLAR] = sScatterbugPolarLevelUpLearnset,
[SPECIES_SCATTERBUG_TUNDRA] = sScatterbugTundraLevelUpLearnset,
[SPECIES_SCATTERBUG_CONTINENTAL] = sScatterbugContinentalLevelUpLearnset,
[SPECIES_SCATTERBUG_GARDEN] = sScatterbugGardenLevelUpLearnset,
[SPECIES_SCATTERBUG_ELEGANT] = sScatterbugElegantLevelUpLearnset,
[SPECIES_SCATTERBUG_MEADOW] = sScatterbugMeadowLevelUpLearnset,
[SPECIES_SCATTERBUG_MODERN] = sScatterbugModernLevelUpLearnset,
[SPECIES_SCATTERBUG_MARINE] = sScatterbugMarineLevelUpLearnset,
[SPECIES_SCATTERBUG_ARCHIPELAGO] = sScatterbugArchipelagoLevelUpLearnset,
[SPECIES_SCATTERBUG_HIGH_PLAINS] = sScatterbugHighPlainsLevelUpLearnset,
[SPECIES_SCATTERBUG_SANDSTORM] = sScatterbugSandstormLevelUpLearnset,
[SPECIES_SCATTERBUG_RIVER] = sScatterbugRiverLevelUpLearnset,
[SPECIES_SCATTERBUG_MONSOON] = sScatterbugMonsoonLevelUpLearnset,
[SPECIES_SCATTERBUG_SAVANNA] = sScatterbugSavannaLevelUpLearnset,
[SPECIES_SCATTERBUG_SUN] = sScatterbugSunLevelUpLearnset,
[SPECIES_SCATTERBUG_OCEAN] = sScatterbugOceanLevelUpLearnset,
[SPECIES_SCATTERBUG_JUNGLE] = sScatterbugJungleLevelUpLearnset,
[SPECIES_SCATTERBUG_FANCY] = sScatterbugFancyLevelUpLearnset,
[SPECIES_SCATTERBUG_POKE_BALL] = sScatterbugPokeBallLevelUpLearnset,
[SPECIES_SPEWPA_POLAR] = sSpewpaPolarLevelUpLearnset,
[SPECIES_SPEWPA_TUNDRA] = sSpewpaTundraLevelUpLearnset,
[SPECIES_SPEWPA_CONTINENTAL] = sSpewpaContinentalLevelUpLearnset,
[SPECIES_SPEWPA_GARDEN] = sSpewpaGardenLevelUpLearnset,
[SPECIES_SPEWPA_ELEGANT] = sSpewpaElegantLevelUpLearnset,
[SPECIES_SPEWPA_MEADOW] = sSpewpaMeadowLevelUpLearnset,
[SPECIES_SPEWPA_MODERN] = sSpewpaModernLevelUpLearnset,
[SPECIES_SPEWPA_MARINE] = sSpewpaMarineLevelUpLearnset,
[SPECIES_SPEWPA_ARCHIPELAGO] = sSpewpaArchipelagoLevelUpLearnset,
[SPECIES_SPEWPA_HIGH_PLAINS] = sSpewpaHighPlainsLevelUpLearnset,
[SPECIES_SPEWPA_SANDSTORM] = sSpewpaSandstormLevelUpLearnset,
[SPECIES_SPEWPA_RIVER] = sSpewpaRiverLevelUpLearnset,
[SPECIES_SPEWPA_MONSOON] = sSpewpaMonsoonLevelUpLearnset,
[SPECIES_SPEWPA_SAVANNA] = sSpewpaSavannaLevelUpLearnset,
[SPECIES_SPEWPA_SUN] = sSpewpaSunLevelUpLearnset,
[SPECIES_SPEWPA_OCEAN] = sSpewpaOceanLevelUpLearnset,
[SPECIES_SPEWPA_JUNGLE] = sSpewpaJungleLevelUpLearnset,
[SPECIES_SPEWPA_FANCY] = sSpewpaFancyLevelUpLearnset,
[SPECIES_SPEWPA_POKE_BALL] = sSpewpaPokeBallLevelUpLearnset,
[SPECIES_PIKACHU_PARTNER] = sPikachuPartnerLevelUpLearnset,
[SPECIES_EEVEE_PARTNER] = sEeveePartnerLevelUpLearnset,
[SPECIES_LUGIA_SHADOW] = sLugiaShadowLevelUpLearnset,
[SPECIES_VENUSAUR_GIGANTAMAX] = sVenusaurGigantamaxLevelUpLearnset,
[SPECIES_BLASTOISE_GIGANTAMAX] = sBlastoiseGigantamaxLevelUpLearnset,
[SPECIES_CHARIZARD_GIGANTAMAX] = sCharizardGigantamaxLevelUpLearnset,
[SPECIES_BUTTERFREE_GIGANTAMAX] = sButterfreeGigantamaxLevelUpLearnset,
[SPECIES_PIKACHU_GIGANTAMAX] = sPikachuGigantamaxLevelUpLearnset,
[SPECIES_MEOWTH_GIGANTAMAX] = sMeowthGigantamaxLevelUpLearnset,
[SPECIES_MACHAMP_GIGANTAMAX] = sMachampGigantamaxLevelUpLearnset,
[SPECIES_GENGAR_GIGANTAMAX] = sGengarGigantamaxLevelUpLearnset,
[SPECIES_KINGLER_GIGANTAMAX] = sKinglerGigantamaxLevelUpLearnset,
[SPECIES_LAPRAS_GIGANTAMAX] = sLaprasGigantamaxLevelUpLearnset,
[SPECIES_EEVEE_GIGANTAMAX] = sEeveeGigantamaxLevelUpLearnset,
[SPECIES_SNORLAX_GIGANTAMAX] = sSnorlaxGigantamaxLevelUpLearnset,
[SPECIES_GARBODOR_GIGANTAMAX] = sGarbodorGigantamaxLevelUpLearnset,
[SPECIES_MELMETAL_GIGANTAMAX] = sMelmetalGigantamaxLevelUpLearnset,
[SPECIES_RILLABOOM_GIGANTAMAX] = sRillaboomGigantamaxLevelUpLearnset,
[SPECIES_CINDERACE_GIGANTAMAX] = sCinderaceGigantamaxLevelUpLearnset,
[SPECIES_INTELEON_GIGANTAMAX] = sInteleonGigantamaxLevelUpLearnset,
[SPECIES_CORVIKNIGHT_GIGANTAMAX] = sCorviknightGigantamaxLevelUpLearnset,
[SPECIES_ORBEETLE_GIGANTAMAX] = sOrbeetleGigantamaxLevelUpLearnset,
[SPECIES_DREDNAW_GIGANTAMAX] = sDrednawGigantamaxLevelUpLearnset,
[SPECIES_COALOSSAL_GIGANTAMAX] = sCoalossalGigantamaxLevelUpLearnset,
[SPECIES_FLAPPLE_GIGANTAMAX] = sFlappleGigantamaxLevelUpLearnset,
[SPECIES_APPLETUN_GIGANTAMAX] = sAppletunGigantamaxLevelUpLearnset,
[SPECIES_SANDACONDA_GIGANTAMAX] = sSandacondaGigantamaxLevelUpLearnset,
[SPECIES_TOXTRICITY_GIGANTAMAX] = sToxtricityGigantamaxLevelUpLearnset,
[SPECIES_CENTISKORCH_GIGANTAMAX] = sCentiskorchGigantamaxLevelUpLearnset,
[SPECIES_HATTERENE_GIGANTAMAX] = sHattereneGigantamaxLevelUpLearnset,
[SPECIES_GRIMMSNARL_GIGANTAMAX] = sGrimmsnarlGigantamaxLevelUpLearnset,
[SPECIES_ALCREMIE_GIGANTAMAX] = sAlcremieGigantamaxLevelUpLearnset,
[SPECIES_COPPERAJAH_GIGANTAMAX] = sCopperajahGigantamaxLevelUpLearnset,
[SPECIES_DURALUDON_GIGANTAMAX] = sDuraludonGigantamaxLevelUpLearnset,
[SPECIES_URSHIFU_SINGLE_STRIKE_STYLE_GIGANTAMAX] = sUrshifuSingleStrikeStyleGigantamaxLevelUpLearnset,
[SPECIES_URSHIFU_RAPID_STRIKE_STYLE_GIGANTAMAX] = sUrshifuRapidStrikeStyleGigantamaxLevelUpLearnset,
[SPECIES_ORIGIN_MEW] = sOriginMewLevelUpLearnset,
