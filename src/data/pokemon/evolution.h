const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU_PARTNER]     = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_RAICHU_ALOLAN}},
    ...
    [SPECIES_GOLBAT]	 = {{EVO_LEVEL, 20, SPECIES_CROBAT}},
    ...
    [SPECIES_ABRA]	     = {{EVO_LEVEL, 14, SPECIES_KADABRA}},
    [SPECIES_KADABRA]	 = {{EVO_LEVEL, 20, SPECIES_ALAKAZAM},
                            {EVO_TRADE, 0, SPECIES_ALAKAZAM}},
    [SPECIES_ALAKAZAM]	 = {{EVO_MEGA_EVOLUTION, ITEM_ALAKAZITE, SPECIES_ALAKAZAM_MEGA}},
    [SPECIES_MACHOP]	 = {{EVO_LEVEL, 14, SPECIES_MACHOKE}},
    [SPECIES_MACHOKE]	 = {{EVO_LEVEL, 20, SPECIES_MACHAMP},
    ...
    [SPECIES_GEODUDE]	 = {{EVO_LEVEL, 14, SPECIES_GRAVELER}},
    [SPECIES_GRAVELER]	 = {{EVO_TRADE, 0, SPECIES_GOLEM},
                            {EVO_LEVEL, 20, SPECIES_GOLEM}},
    ...
    [SPECIES_MAGNEMITE]	 = {{EVO_LEVEL, 30, SPECIES_MAGNETON},
                            {EVO_ITEM, ITEM_METAL_COAT, SPECIES_SANDY_SHOCKS}},
    ...
    [SPECIES_GASTLY]	 = {{EVO_LEVEL, 14, SPECIES_HAUNTER}},
    [SPECIES_HAUNTER]	 = {{EVO_LEVEL, 20, SPECIES_GENGAR},
    ...
    [SPECIES_SCYTHER]    = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_KLEAVOR},
    ...
    [SPECIES_EEVEE_PARTNER]      = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                            {EVO_ITEM, ITEM_WATER_STONE, SPECIES_VAPOREON},
                            {EVO_ITEM, ITEM_FIRE_STONE, SPECIES_FLAREON},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ESPEON},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_UMBREON},
    ...
    [SPECIES_PICHU]	     = {{EVO_LEVEL, 22, SPECIES_PIKACHU},
                            {EVO_ITEM_HOLD, ITEM_PIKASHUNIUM_Z, SPECIES_PIKACHU_PARTNER}},
    ...
    [SPECIES_PUPITAR]	 = {{EVO_LEVEL, 55, SPECIES_TYRANITAR},
                            {EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_THORNS}},
    ...
    [SPECIES_MAKUHITA]	 = {{EVO_LEVEL, 24, SPECIES_HARIYAMA},
                            {EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_HANDS}},
    ...
    [SPECIES_SHELGON]	 = {{EVO_LEVEL, 50, SPECIES_SALAMENCE},
                             {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ROARING_MOON}},
	...
	[SPECIES_BUDEW]	     = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_ROSELIA}},
	[SPECIES_CRANIDOS]	 = {{EVO_LEVEL, 30, SPECIES_RAMPARDOS}},
	[SPECIES_SHIELDON]	 = {{EVO_LEVEL, 30, SPECIES_BASTIODON}},
	[SPECIES_BURMY]	     = {{EVO_LEVEL_FEMALE, 10, SPECIES_WORMADAM},
                            {EVO_LEVEL_MALE, 10, SPECIES_MOTHIM}},
	...
	[SPECIES_MUNCHLAX]	 = {{EVO_LEVEL, 16, SPECIES_SNORLAX}},
	[SPECIES_RIOLU]	     = {{EVO_LEVEL, 16, SPECIES_LUCARIO}},
	...
	[SPECIES_ROGGENROLA] = {{EVO_LEVEL, 14, SPECIES_BOLDORE}},
	[SPECIES_BOLDORE]	 = {{EVO_LEVEL, 25, SPECIES_GIGALITH},
                            {EVO_TRADE, 0, SPECIES_GIGALITH}},
	[SPECIES_WOOBAT]	 = {{EVO_LEVEL, 11, SPECIES_SWOOBAT}},
	[SPECIES_DRILBUR]	 = {{EVO_LEVEL, 31, SPECIES_EXCADRILL}},
	[SPECIES_AUDINO]	 = {{EVO_MEGA_EVOLUTION, ITEM_AUDINITE, SPECIES_AUDINO_MEGA}},
	[SPECIES_TIMBURR]	 = {{EVO_LEVEL, 14, SPECIES_GURDURR}},
	[SPECIES_GURDURR]	 = {{EVO_LEVEL, 25, SPECIES_CONKELDURR},
	...
	[SPECIES_SEWADDLE]	 = {{EVO_LEVEL, 9, SPECIES_SWADLOON}},
	[SPECIES_SWADLOON]	 = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LEAVANNY}},
	...
	[SPECIES_FOONGUS]	 = {{EVO_LEVEL, 39, SPECIES_AMOONGUSS},
                            {EVO_ITEM, ITEM_SUN_STONE, SPECIES_BRUTE_BONNET}},
	...
	[SPECIES_RUFFLET]	 = {{EVO_LEVEL, 34, SPECIES_BRAVIARY},
                            {EVO_ITEM, ITEM_SHINY_STONE, SPECIES_BRAVIARY_HISUIAN}},
	...
	[SPECIES_ZWEILOUS]	 = {{EVO_LEVEL, 54, SPECIES_HYDREIGON},
                            {EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_JUGULIS}},
	...
	[SPECIES_PHANTUMP]	 = {{EVO_LEVEL, 20, SPECIES_TREVENANT},
	...
	[SPECIES_NOIBAT]	 = {{EVO_LEVEL, 21, SPECIES_NOIVERN}},
	...
	[SPECIES_BOUNSWEET]	 = {{EVO_LEVEL, 10, SPECIES_STEENEE}},
	...
	[SPECIES_TYPE_NULL]	 = {{EVO_LEVEL, 35, SPECIES_SILVALLY}},
    ...
    [SPECIES_SKWOVET]               = {{EVO_LEVEL, 11, SPECIES_GREEDENT}},
    ...
    [SPECIES_DOTTLER]               = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_ORBEETLE}},
    ...
    [SPECIES_ARROKUDA]              = {{EVO_LEVEL, 26, SPECIES_BARRASKEWDA},
                                           {EVO_ITEM, ITEM_METAL_COAT, SPECIES_VELUZA}},
    ...
    [SPECIES_MILCERY]               = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_ALCREMIE},
                                       ...
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_ALCREMIE_MINT_CREAM},
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_ALCREMIE_LEMON_CREAM},
                                       {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_ALCREMIE_SALTED_CREAM},
                                       {EVO_ITEM, ITEM_SUN_STONE, SPECIES_ALCREMIE_RUBY_SWIRL},
                                       {EVO_ITEM, ITEM_ICE_STONE, SPECIES_ALCREMIE_CARAMEL_SWIRL},
                                       {EVO_ITEM, ITEM_MOON_STONE, SPECIES_ALCREMIE_RAINBOW_SWIRL}},
    ...
    [SPECIES_GEODUDE_ALOLAN]	 = {{EVO_LEVEL, 14, SPECIES_GRAVELER_ALOLAN}},
    [SPECIES_GRAVELER_ALOLAN]	 = {{EVO_LEVEL, 10, SPECIES_GOLEM_ALOLAN},
    ...
    [SPECIES_FARFETCHD_GALARIAN]    = {{EVO_LEVEL, 20, SPECIES_SIRFETCHD}},
    ...
    [SPECIES_YAMASK_GALARIAN]       = {{EVO_LEVEL, 20, SPECIES_RUNERIGUS}},

    [SPECIES_BURMY_SANDY_CLOAK]     = {{EVO_LEVEL_FEMALE, 10, SPECIES_WORMADAM_SANDY_CLOAK},
                                       {EVO_LEVEL_MALE, 10, SPECIES_MOTHIM_SANDY_CLOAK}},
    [SPECIES_BURMY_TRASH_CLOAK]     = {{EVO_LEVEL_FEMALE, 10, SPECIES_WORMADAM_TRASH_CLOAK},
                                       {EVO_LEVEL_MALE, 10, SPECIES_MOTHIM_TRASH_CLOAK}},
    ...
    [SPECIES_SINISTEA_ANTIQUE]      = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_POLTEAGEIST_ANTIQUE}},
     ...
     [SPECIES_PRIMEAPE]   = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_ANNIHILAPE}},
     [SPECIES_URSARING]   = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_URSALUNA},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_URSALUNA_BLOODMOON}},
    [SPECIES_BASCULIN]                 = {{EVO_LEVEL_MALE, 30, SPECIES_BASCULEGION_MALE},
                                       {EVO_LEVEL_FEMALE, 30, SPECIES_BASCULEGION_FEMALE}},
    [SPECIES_BASCULIN_WHITE_STRIPED]                 = {{EVO_LEVEL_MALE, 30, SPECIES_BASCULEGION_MALE},
                                       {EVO_LEVEL_FEMALE, 30, SPECIES_BASCULEGION_FEMALE}},
    [SPECIES_BASCULIN_BLUE_STRIPED]                 = {{EVO_LEVEL_MALE, 30, SPECIES_BASCULEGION_MALE},
                                       {EVO_LEVEL_FEMALE, 30, SPECIES_BASCULEGION_FEMALE}},                                                                              
     [SPECIES_SNEASEL_HISUIAN]   = {{EVO_ITEM, ITEM_RAZOR_CLAW, SPECIES_SNEASLER}},
     [SPECIES_QWILFISH]   = {{EVO_LEVEL, 31, SPECIES_OVERQWIL}},
     ...
     [SPECIES_ZORUA_HISUIAN]   = {{EVO_LEVEL, 31, SPECIES_ZOROARK_HISUIAN}},
    ...
    [SPECIES_LECHONK]                = {{EVO_LEVEL_MALE, 18, SPECIES_OINKOLOGNE_MALE},
     ...
     [SPECIES_MAUSHOLD_THREE]   = {{EVO_LEVEL, 35, SPECIES_MAUSHOLD_FOUR}},
    ...
    [SPECIES_CHARCADET]                = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_ARMAROUGE},
     ...
     [SPECIES_SHROODLE]   = {{EVO_LEVEL, 35, SPECIES_GRAFAIAI}},
     [SPECIES_BRAMBLIN]   = {{EVO_LEVEL, 18, SPECIES_BRAMBLEGHAST}},
     [SPECIES_TOEDSCOOL]   = {{EVO_LEVEL, 30, SPECIES_TOEDSCRUEL}},
     [SPECIES_CAPSAKID]   = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_SCOVILLAIN}},
     [SPECIES_RELLOR]   = {{EVO_LEVEL, 15, SPECIES_RABSCA}},
     ...
     [SPECIES_FINIZEN]   = {{EVO_LEVEL, 31, SPECIES_PALAFIN_ZERO}}, 
     [SPECIES_PALAFIN_ZERO]   = {{EVO_LEVEL, 48, SPECIES_PALAFIN_HERO}},
     ...
     [SPECIES_GIRAFARIG]   = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_FARIGIRAF}},
     [SPECIES_DUNSPARCE]   = {{EVO_LEVEL, 22, SPECIES_DUDUNSPARCE_TWO}},
     [SPECIES_DUDUNSPARCE_TWO]   = {{EVO_LEVEL, 33, SPECIES_DUDUNSPARCE_THREE}},
     [SPECIES_BISHARP]   = {{EVO_LEVEL, 50, SPECIES_KINGAMBIT}},
     [SPECIES_DELIBIRD]   = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_BUNDLE}},
     [SPECIES_FRIGIBAX]   = {{EVO_LEVEL, 35, SPECIES_ARCTIBAX}},
     [SPECIES_ARCTIBAX]   = {{EVO_LEVEL, 54, SPECIES_BAXCALIBUR}},
     [SPECIES_GIMMIGHOUL_CHEST]   = {{EVO_ITEM, ITEM_NUGGET, SPECIES_GHOLDENGO}},
     [SPECIES_GIMMIGHOUL_ROAMING]   = {{EVO_ITEM, ITEM_NUGGET, SPECIES_GHOLDENGO}},
     [SPECIES_POLTCHAGEIST_ARTISAN]   = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_SINISTCHA_MASTERPIECE}},
     [SPECIES_POLTCHAGEIST_COUNTERFEIT]   = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_SINISTCHA_UNREMARKABLE}},
     [SPECIES_SCATTERBUG_POLAR]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_POLAR}},
     [SPECIES_SPEWPA_POLAR]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_POLAR}},
     [SPECIES_SCATTERBUG_TUNDRA]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_TUNDRA}},
     [SPECIES_SPEWPA_TUNDRA]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_TUNDRA}},
     [SPECIES_SCATTERBUG_CONTINENTAL]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_CONTINENTAL}},
     [SPECIES_SPEWPA_CONTINENTAL]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_CONTINENTAL}},
     [SPECIES_SCATTERBUG_GARDEN]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_GARDEN}},
     [SPECIES_SPEWPA_GARDEN]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_GARDEN}},
     [SPECIES_SCATTERBUG_ELEGANT]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_ELEGANT}},
     [SPECIES_SPEWPA_ELEGANT]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_ELEGANT}},
     [SPECIES_SCATTERBUG_MEADOW]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_MEADOW}},
     [SPECIES_SPEWPA_MEADOW]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_MEADOW}},
     [SPECIES_SCATTERBUG_MODERN]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_MODERN}},
     [SPECIES_SPEWPA_MODERN]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_MODERN}},
     [SPECIES_SCATTERBUG_MARINE]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_MARINE}},
     [SPECIES_SPEWPA_MARINE]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_MARINE}},
     [SPECIES_SCATTERBUG_ARCHIPELAGO]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_ARCHIPELAGO}},
     [SPECIES_SPEWPA_ARCHIPELAGO]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_ARCHIPELAGO}},
     [SPECIES_SCATTERBUG_HIGH_PLAINS]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_HIGH_PLAINS}},
     [SPECIES_SPEWPA_HIGH_PLAINS]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_HIGH_PLAINS}},
     [SPECIES_SCATTERBUG_SANDSTORM]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_SANDSTORM}},
     [SPECIES_SPEWPA_SANDSTORM]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_SANDSTORM}},
     [SPECIES_SCATTERBUG_RIVER]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_RIVER}},
     [SPECIES_SPEWPA_RIVER]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_RIVER}},
     [SPECIES_SCATTERBUG_MONSOON]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_MONSOON}},
     [SPECIES_SPEWPA_MONSOON]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_MONSOON}},
     [SPECIES_SCATTERBUG_SAVANNA]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_SAVANNA}},
     [SPECIES_SPEWPA_SAVANNA]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_SAVANNA}},
     [SPECIES_SCATTERBUG_SUN]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_SUN}},
     [SPECIES_SPEWPA_SUN]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_SUN}},
     [SPECIES_SCATTERBUG_OCEAN]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_OCEAN}},
     [SPECIES_SPEWPA_OCEAN]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_OCEAN}},
     [SPECIES_SCATTERBUG_JUNGLE]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_JUNGLE}},
     [SPECIES_SPEWPA_JUNGLE]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_JUNGLE}},
     [SPECIES_SCATTERBUG_FANCY]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_FANCY}},
     [SPECIES_SPEWPA_FANCY]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_FANCY}},
     [SPECIES_SCATTERBUG_POKE_BALL]   = {{EVO_LEVEL, 8, SPECIES_SPEWPA_POKE_BALL}},
     [SPECIES_SPEWPA_POKE_BALL]   = {{EVO_LEVEL, 10, SPECIES_VIVILLON_POKE_BALL}},

         [SPECIES_TERAPAGOS]   = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_TERAPAGOS_TERASTAL}},
           [SPECIES_DIPPLIN]   = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_HYDRAPPLE}},
