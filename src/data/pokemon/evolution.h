const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_SCYTHER]   = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_KLEAVOR}},
     [SPECIES_URSARING]   = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_URSALUNA}},
     [SPECIES_URSARING]   = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_URSALUNA_BLOODMOON}},
    ...
    [SPECIES_BASCULIN_BLUE_STRIPED]                 = {{EVO_LEVEL_MALE, 30, SPECIES_BASCULEGION_MALE},
     ...
     [SPECIES_QUILAVA]   = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_TYPHLOSION_HISUIAN}},
     [SPECIES_DEWOTT]   = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_SAMUROTT_HISUIAN}},
     [SPECIES_PETILIL]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT_HISUIAN}},
     [SPECIES_ZORUA_HISUIAN]   = {{EVO_LEVEL, 31, SPECIES_ZOROARK_HISUIAN}},
     [SPECIES_RUFFLET]   = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_BRAVIARY_HISUIAN}},
     [SPECIES_GOOMY]   = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_SLIGGOO_HISUIAN}},
     [SPECIES_SLIGGOO_HISUIAN]   = {{EVO_LEVEL, 50, SPECIES_GOODRA_HISUIAN}},
     [SPECIES_BERGMITE]   = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_AVALUGG_HISUIAN}},
     [SPECIES_DARTRIX]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_DECIDUEYE_HISUIAN}}, 
    ...
    [SPECIES_CHARCADET]                = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_ARMAROUGE},
     ...
     [SPECIES_PHANPY]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_GREAT_TUSK}},
     [SPECIES_PHANPY]   = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_TREADS}},
     [SPECIES_JIGGLYPUFF]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SCREAM_TAIL}},
     [SPECIES_FOONGUS]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_BRUTE_BONNET}},
     [SPECIES_MISDREAVUS]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_FLUTTER_MANE}},
     [SPECIES_LARVESTA]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_SLITHER_WING}},
     [SPECIES_LARVESTA]   = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_MOTH}},
     [SPECIES_MAGNEMITE]   = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_SANDY_SHOCKS}},
     [SPECIES_DELIBIRD]   = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_BUNDLE}},
     [SPECIES_MAKUHITA]   = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_HANDS}},
     [SPECIES_ZWEILOUS]   = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_JUGULIS}},
     [SPECIES_PUPITAR]   = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_THORNS}},
     ...
     [SPECIES_SHELGON]   = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_ROARING_MOON}},
     [SPECIES_KIRLIA]   = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_IRON_VALIANT}},
