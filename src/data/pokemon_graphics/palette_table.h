...
SPECIES_PAL(ARCANINE_HISUIAN, gMonPalette_ArcanineHisuiian),
...
SPECIES_PAL(OINKOLOGNE_MALE, gMonPalette_OinkologneMale),
...
SPECIES_PAL(MAUSHOLD_THREE, gMonPalette_MausholdThree),
SPECIES_PAL(MAUSHOLD_FOUR, gMonPalette_MausholdFour),
...
SPECIES_PAL(SQUAWKABILLY_GREEN, gMonPalette_SquawkabillyGreen),
...
SPECIES_PAL(PALAFIN_ZERO, gMonPalette_PalafinZero),
...
SPECIES_PAL(TATSUGIRI_CURLY, gMonPalette_TatsugiriCurly),
...
SPECIES_PAL(DUDUNSPARCE_TWO, gMonPalette_DudunsparceTwo),
...
SPECIES_PAL(TAUROS_PALDEAN_COMBAT_BREED, gMonPalette_TaurosPaldeanCombatBreed),
SPECIES_PAL(TAUROS_PALDEAN_BLAZE_BREED, gMonPalette_TaurosPaldeanBlazeBreed),
SPECIES_PAL(TAUROS_PALDEAN_AQUA_BREED, gMonPalette_TaurosPaldeanAquaBreed),
...
SPECIES_PAL(POLTCHAGEIST_COUNTERFEIT, gMonPalette_PoltchageistCounterfeit),
SPECIES_PAL(POLTCHAGEIST_ARTISAN, gMonPalette_PoltchageistArtisan),
SPECIES_PAL(SINISTCHA_UNREMARKABLE, gMonPalette_SinistchaUnremarkable),
...
SPECIES_PAL(OGERPON_TEAL, gMonPalette_OgerponTeal),
...
SPECIES_PAL(OGERPON_TEAL_MASK_TERA, gMonPalette_OgerponTealMaskTera),
SPECIES_PAL(OGERPON_WELLSPRING_MASK_TERA, gMonPalette_OgerponWellspringMaskTera),
SPECIES_PAL(OGERPON_HEARTHFLAME_MASK_TERA, gMonPalette_OgerponHearthflameMaskTera),
SPECIES_PAL(OGERPON_CORNERSTONE_MASK_TERA, gMonPalette_OgerponCornerstoneMaskTera),
SPECIES_PAL(URSALUNA_BLOODMOON, gMonPalette_Ursaluna_Bloodmoon),
SPECIES_PAL(MOTHIM_SANDY_CLOAK, gMonPalette_MothimSandyCloak),
SPECIES_PAL(MOTHIM_TRASH_CLOAK, gMonPalette_MothimTrashCloak),
SPECIES_PAL(SCATTERBUG_POLAR, gMonPalette_ScatterbugPolar),
SPECIES_PAL(SCATTERBUG_TUNDRA, gMonPalette_ScatterbugTundra),
SPECIES_PAL(SCATTERBUG_CONTINENTAL, gMonPalette_ScatterbugContinental),
SPECIES_PAL(SCATTERBUG_GARDEN, gMonPalette_ScatterbugGarden),
SPECIES_PAL(SCATTERBUG_ELEGANT, gMonPalette_ScatterbugElegant),
SPECIES_PAL(SCATTERBUG_MEADOW, gMonPalette_ScatterbugMeadow),
SPECIES_PAL(SCATTERBUG_MODERN, gMonPalette_ScatterbugModern),
SPECIES_PAL(SCATTERBUG_MARINE, gMonPalette_ScatterbugMarine),
SPECIES_PAL(SCATTERBUG_ARCHIPELAGO, gMonPalette_ScatterbugArchipelago),
SPECIES_PAL(SCATTERBUG_HIGH_PLAINS, gMonPalette_ScatterbugHighPlains),
SPECIES_PAL(SCATTERBUG_SANDSTORM, gMonPalette_ScatterbugSandstorm),
SPECIES_PAL(SCATTERBUG_RIVER, gMonPalette_ScatterbugRiver),
SPECIES_PAL(SCATTERBUG_MONSOON, gMonPalette_ScatterbugMonsoon),
SPECIES_PAL(SCATTERBUG_SAVANNA, gMonPalette_ScatterbugSavanna),
SPECIES_PAL(SCATTERBUG_SUN, gMonPalette_ScatterbugSun),
SPECIES_PAL(SCATTERBUG_OCEAN, gMonPalette_ScatterbugOcean),
SPECIES_PAL(SCATTERBUG_JUNGLE, gMonPalette_ScatterbugJungle),
SPECIES_PAL(SCATTERBUG_FANCY, gMonPalette_ScatterbugFancy),
SPECIES_PAL(SCATTERBUG_POKE_BALL, gMonPalette_ScatterbugPokeBall),
SPECIES_PAL(SPEWPA_POLAR, gMonPalette_SpewpaPolar),
SPECIES_PAL(SPEWPA_TUNDRA, gMonPalette_SpewpaTundra),
SPECIES_PAL(SPEWPA_CONTINENTAL, gMonPalette_SpewpaContinental),
SPECIES_PAL(SPEWPA_GARDEN, gMonPalette_SpewpaGarden),
SPECIES_PAL(SPEWPA_ELEGANT, gMonPalette_SpewpaElegant),
SPECIES_PAL(SPEWPA_MEADOW, gMonPalette_SpewpaMeadow),
SPECIES_PAL(SPEWPA_MODERN, gMonPalette_SpewpaModern),
SPECIES_PAL(SPEWPA_MARINE, gMonPalette_SpewpaMarine),
SPECIES_PAL(SPEWPA_ARCHIPELAGO, gMonPalette_SpewpaArchipelago),
SPECIES_PAL(SPEWPA_HIGH_PLAINS, gMonPalette_SpewpaHighPlains),
SPECIES_PAL(SPEWPA_SANDSTORM, gMonPalette_SpewpaSandstorm),
SPECIES_PAL(SPEWPA_RIVER, gMonPalette_SpewpaRiver),
SPECIES_PAL(SPEWPA_MONSOON, gMonPalette_SpewpaMonsoon),
SPECIES_PAL(SPEWPA_SAVANNA, gMonPalette_SpewpaSavanna),
SPECIES_PAL(SPEWPA_SUN, gMonPalette_SpewpaSun),
SPECIES_PAL(SPEWPA_OCEAN, gMonPalette_SpewpaOcean),
SPECIES_PAL(SPEWPA_JUNGLE, gMonPalette_SpewpaJungle),
SPECIES_PAL(SPEWPA_FANCY, gMonPalette_SpewpaFancy),
SPECIES_PAL(SPEWPA_POKE_BALL, gMonPalette_SpewpaPokeBall),
SPECIES_PAL(PIKACHU_PARTNER, gMonPalette_PikachuPartner),
SPECIES_PAL(EEVEE_PARTNER, gMonPalette_EeveePartner),
SPECIES_PAL(LUGIA_SHADOW, gMonPalette_LugiaShadow),
