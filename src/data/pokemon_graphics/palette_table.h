...
SPECIES_PAL(BASCULEGION_MALE, gMonPalette_Basculegion_Male),
...
SPECIES_PAL(ARCANINE_HISUIAN, gMonPalette_Arcanine_Hisuiian),
SPECIES_PAL(VOLTORB_HISUIAN, gMonPalette_Voltorb_Hisuian),
SPECIES_PAL(ELECTRODE_HISUIAN, gMonPalette_Electrode_Hisuian),
SPECIES_PAL(TYPHLOSION_HISUIAN, gMonPalette_Typhlosion_Hisuian),
SPECIES_PAL(QWILFISH_HISUIAN, gMonPalette_Qwilfish_Hisuian),
SPECIES_PAL(SNEASEL_HISUIAN, gMonPalette_Sneasel_Hisuian),
SPECIES_PAL(SAMUROTT_HISUIAN, gMonPalette_Samurott_Hisuian),
SPECIES_PAL(LILLIGANT_HISUIAN, gMonPalette_Lilligant_Hisuian),
SPECIES_PAL(ZORUA_HISUIAN, gMonPalette_Zorua_Hisuian),
SPECIES_PAL(ZOROARK_HISUIAN, gMonPalette_Zoroark_Hisuian),
SPECIES_PAL(BRAVIARY_HISUIAN, gMonPalette_Braviary_Hisuian),
SPECIES_PAL(SLIGGOO_HISUIAN, gMonPalette_Sliggoo_Hisuian),
SPECIES_PAL(GOODRA_HISUIAN, gMonPalette_Goodra_Hisuian),
SPECIES_PAL(AVALUGG_HISUIAN, gMonPalette_Avalugg_Hisuian),
SPECIES_PAL(DECIDUEYE_HISUIAN, gMonPalette_Decidueye_Hisuian),
SPECIES_PAL(DIALGA_ORIGIN, gMonPalette_Dialga_Origin),
SPECIES_PAL(PALKIA_ORIGIN, gMonPalette_Palkia_Origin),
SPECIES_PAL(BASCULIN_WHITE_STRIPED, gMonPalette_Basculin_WhiteStriped),
...
SPECIES_PAL(OINKOLOGNE_MALE, gMonPalette_Oinkologne_Male),
SPECIES_PAL(OINKOLOGNE_FEMALE, gMonPalette_Oinkologne_Female),
...
SPECIES_PAL(MAUSHOLD_THREE, gMonPalette_Maushold_Three),
SPECIES_PAL(MAUSHOLD_FOUR, gMonPalette_Maushold_Four),
...
SPECIES_PAL(SQUAWKABILLY_GREEN, gMonPalette_Squawkabilly_Green),
SPECIES_PAL(SQUAWKABILLY_BLUE, gMonPalette_Squawkabilly_Blue),
SPECIES_PAL(SQUAWKABILLY_YELLOW, gMonPalette_Squawkabilly_Yellow),
SPECIES_PAL(SQUAWKABILLY_WHITE, gMonPalette_Squawkabilly_White),
...
SPECIES_PAL(PALAFIN_ZERO, gMonPalette_Palafin_Zero),
SPECIES_PAL(PALAFIN_HERO, gMonPalette_Palafin_Hero),
...
SPECIES_PAL(TATSUGIRI_CURLY, gMonPalette_Tatsugiri_Curly),
SPECIES_PAL(TATSUGIRI_DROOPY, gMonPalette_Tatsugiri_Droopy),
SPECIES_PAL(TATSUGIRI_STRETCHY, gMonPalette_Tatsugiri_Stretchy),
SPECIES_PAL(CLODSIRE, gMonPalette_Clodsire),
SPECIES_PAL(FARIGIRAF, gMonPalette_Farigiraf),
SPECIES_PAL(DUDUNSPARCE_TWO, gMonPalette_Dudunsparce_Two),
SPECIES_PAL(DUDUNSPARCE_THREE, gMonPalette_Dudunsparce_Three),
SPECIES_PAL(KINGAMBIT, gMonPalette_Kingambit),
SPECIES_PAL(GREAT_TUSK, gMonPalette_Great_Tusk),
SPECIES_PAL(SCREAM_TAIL, gMonPalette_Scream_Tail),
SPECIES_PAL(BRUTE_BONNET, gMonPalette_Brute_Bonnet),
SPECIES_PAL(FLUTTER_MANE, gMonPalette_Flutter_Mane),
SPECIES_PAL(SLITHER_WING, gMonPalette_Slither_Wing),
SPECIES_PAL(SANDY_SHOCKS, gMonPalette_Sandy_Shocks),
SPECIES_PAL(IRON_TREADS, gMonPalette_Iron_Treads),
SPECIES_PAL(IRON_BUNDLE, gMonPalette_Iron_Bundle),
SPECIES_PAL(IRON_HANDS, gMonPalette_Iron_Hands),
SPECIES_PAL(IRON_JUGULIS, gMonPalette_Iron_Jugulis),
SPECIES_PAL(IRON_MOTH, gMonPalette_Iron_Moth),
SPECIES_PAL(IRON_THORNS, gMonPalette_Iron_Thorns),
...
SPECIES_PAL(GIMMIGHOUL_CHEST, gMonPalette_Gimmighoul_Chest),
SPECIES_PAL(GIMMIGHOUL_ROAMING, gMonPalette_Gimmighoul_Roaming),
SPECIES_PAL(GHOLDENGO, gMonPalette_Gholdengo),
SPECIES_PAL(WO_CHIEN, gMonPalette_Wo_Chien),
SPECIES_PAL(CHIEN_PAO, gMonPalette_Chien_Pao),
SPECIES_PAL(TING_LU, gMonPalette_Ting_Lu),
SPECIES_PAL(CHI_YU, gMonPalette_Chi_Yu),
SPECIES_PAL(ROARING_MOON, gMonPalette_Roaring_Moon),
SPECIES_PAL(IRON_VALIANT, gMonPalette_Iron_Valiant),
SPECIES_PAL(KORAIDON, gMonPalette_Koraidon),
SPECIES_PAL(MIRAIDON, gMonPalette_Miraidon),
SPECIES_PAL(TAUROS_PALDEAN_COMBAT_BREED, gMonPalette_Tauros_Paldean_Combat_Breed),
SPECIES_PAL(TAUROS_PALDEAN_BLAZE_BREED, gMonPalette_Tauros_Paldean_Blaze_Breed),
SPECIES_PAL(TAUROS_PALDEAN_AQUA_BREED, gMonPalette_Tauros_Paldean_Aqua_Breed),
SPECIES_PAL(WOOPER_PALDEAN, gMonPalette_Wooper_Paldean),
SPECIES_PAL(WALKING_WAKE, gMonPalette_Walking_Wake),
SPECIES_PAL(IRON_LEAVES, gMonPalette_Iron_Leaves),
SPECIES_PAL(DIPPLIN, gMonPalette_Dipplin),
SPECIES_PAL(POLTCHAGEIST_COUNTERFEIT, gMonPalette_Poltchageist_Counterfeit),
SPECIES_PAL(POLTCHAGEIST_ARTISAN, gMonPalette_Poltchageist_Artisan),
SPECIES_PAL(SINISTCHA_UNREMARKABLE, gMonPalette_Sinistcha_Unremarkable),
SPECIES_PAL(SINISTCHA_MASTERPIECE, gMonPalette_Sinistcha_Masterpiece),
...
SPECIES_PAL(OGERPON_TEAL, gMonPalette_Ogerpon_Teal),
SPECIES_PAL(OGERPON_WELLSPRING, gMonPalette_Ogerpon_Wellspring),
SPECIES_PAL(OGERPON_HEARTHFLAME, gMonPalette_Ogerpon_Hearthflame),
SPECIES_PAL(OGERPON_CORNERSTONE, gMonPalette_Ogerpon_Cornerstone),
SPECIES_PAL(OGERPON_TEAL_MASK_TERA, gMonPalette_Ogerpon_Teal_Mask_Tera),
SPECIES_PAL(OGERPON_WELLSPRING_MASK_TERA, gMonPalette_Ogerpon_Wellspring_Mask_Tera),
SPECIES_PAL(OGERPON_HEARTHFLAME_MASK_TERA, gMonPalette_Ogerpon_Hearthflame_Mask_Tera),
SPECIES_PAL(OGERPON_CORNERSTONE_MASK_TERA, gMonPalette_Ogerpon_Cornerstone_Mask_Tera),
SPECIES_PAL(URSALUNA_BLOODMOON, gMonPalette_Ursaluna_Bloodmoon),
SPECIES_PAL(MOTHIM_SANDY_CLOAK, gMonPalette_Mothim_Sandy_Cloak),
SPECIES_PAL(MOTHIM_TRASH_CLOAK, gMonPalette_Mothim_Trash_Cloak),
SPECIES_PAL(SCATTERBUG_POLAR, gMonPalette_Scatterbug_Polar),
SPECIES_PAL(SCATTERBUG_TUNDRA, gMonPalette_Scatterbug_Tundra),
SPECIES_PAL(SCATTERBUG_CONTINENTAL, gMonPalette_Scatterbug_Continental),
SPECIES_PAL(SCATTERBUG_GARDEN, gMonPalette_Scatterbug_Garden),
SPECIES_PAL(SCATTERBUG_ELEGANT, gMonPalette_Scatterbug_Elegant),
SPECIES_PAL(SCATTERBUG_MEADOW, gMonPalette_Scatterbug_Meadow),
SPECIES_PAL(SCATTERBUG_MODERN, gMonPalette_Scatterbug_Modern),
SPECIES_PAL(SCATTERBUG_MARINE, gMonPalette_Scatterbug_Marine),
SPECIES_PAL(SCATTERBUG_ARCHIPELAGO, gMonPalette_Scatterbug_Archipelago),
SPECIES_PAL(SCATTERBUG_HIGH_PLAINS, gMonPalette_Scatterbug_High_Plains),
SPECIES_PAL(SCATTERBUG_SANDSTORM, gMonPalette_Scatterbug_Sandstorm),
SPECIES_PAL(SCATTERBUG_RIVER, gMonPalette_Scatterbug_River),
SPECIES_PAL(SCATTERBUG_MONSOON, gMonPalette_Scatterbug_Monsoon),
SPECIES_PAL(SCATTERBUG_SAVANNA, gMonPalette_Scatterbug_Savanna),
SPECIES_PAL(SCATTERBUG_SUN, gMonPalette_Scatterbug_Sun),
SPECIES_PAL(SCATTERBUG_OCEAN, gMonPalette_Scatterbug_Ocean),
SPECIES_PAL(SCATTERBUG_JUNGLE, gMonPalette_Scatterbug_Jungle),
SPECIES_PAL(SCATTERBUG_FANCY, gMonPalette_Scatterbug_Fancy),
SPECIES_PAL(SCATTERBUG_POKE_BALL, gMonPalette_Scatterbug_Poke_Ball),
SPECIES_PAL(SPEWPA_POLAR, gMonPalette_Spewpa_Polar),
SPECIES_PAL(SPEWPA_TUNDRA, gMonPalette_Spewpa_Tundra),
SPECIES_PAL(SPEWPA_CONTINENTAL, gMonPalette_Spewpa_Continental),
SPECIES_PAL(SPEWPA_GARDEN, gMonPalette_Spewpa_Garden),
SPECIES_PAL(SPEWPA_ELEGANT, gMonPalette_Spewpa_Elegant),
SPECIES_PAL(SPEWPA_MEADOW, gMonPalette_Spewpa_Meadow),
SPECIES_PAL(SPEWPA_MODERN, gMonPalette_Spewpa_Modern),
SPECIES_PAL(SPEWPA_MARINE, gMonPalette_Spewpa_Marine),
SPECIES_PAL(SPEWPA_ARCHIPELAGO, gMonPalette_Spewpa_Archipelago),
SPECIES_PAL(SPEWPA_HIGH_PLAINS, gMonPalette_Spewpa_High_Plains),
SPECIES_PAL(SPEWPA_SANDSTORM, gMonPalette_Spewpa_Sandstorm),
SPECIES_PAL(SPEWPA_RIVER, gMonPalette_Spewpa_River),
SPECIES_PAL(SPEWPA_MONSOON, gMonPalette_Spewpa_Monsoon),
SPECIES_PAL(SPEWPA_SAVANNA, gMonPalette_Spewpa_Savanna),
SPECIES_PAL(SPEWPA_SUN, gMonPalette_Spewpa_Sun),
SPECIES_PAL(SPEWPA_OCEAN, gMonPalette_Spewpa_Ocean),
SPECIES_PAL(SPEWPA_JUNGLE, gMonPalette_Spewpa_Jungle),
SPECIES_PAL(SPEWPA_FANCY, gMonPalette_Spewpa_Fancy),
SPECIES_PAL(SPEWPA_POKE_BALL, gMonPalette_Spewpa_Poke_Ball),
SPECIES_PAL(PIKACHU_PARTNER, gMonPalette_Pikachu_Partner),
SPECIES_PAL(EEVEE_PARTNER, gMonPalette_Eevee_Partner),
SPECIES_PAL(LUGIA_SHADOW, gMonPalette_Lugia_Shadow),
SPECIES_PAL(VENUSAUR_GIGANTAMAX, gMonPalette_Venusaur_Gigantamax),
SPECIES_PAL(BLASTOISE_GIGANTAMAX, gMonPalette_Blastoise_Gigantamax),
SPECIES_PAL(CHARIZARD_GIGANTAMAX, gMonPalette_Charizard_Gigantamax),
SPECIES_PAL(BUTTERFREE_GIGANTAMAX, gMonPalette_Butterfree_Gigantamax),
SPECIES_PAL(PIKACHU_GIGANTAMAX, gMonPalette_Pikachu_Gigantamax),
SPECIES_PAL(MEOWTH_GIGANTAMAX, gMonPalette_Meowth_Gigantamax),
SPECIES_PAL(MACHAMP_GIGANTAMAX, gMonPalette_Machamp_Gigantamax),
SPECIES_PAL(GENGAR_GIGANTAMAX, gMonPalette_Gengar_Gigantamax),
SPECIES_PAL(KINGLER_GIGANTAMAX, gMonPalette_Kingler_Gigantamax),
SPECIES_PAL(LAPRAS_GIGANTAMAX, gMonPalette_Lapras_Gigantamax),
SPECIES_PAL(EEVEE_GIGANTAMAX, gMonPalette_Eevee_Gigantamax),
SPECIES_PAL(SNORLAX_GIGANTAMAX, gMonPalette_Snorlax_Gigantamax),
SPECIES_PAL(GARBODOR_GIGANTAMAX, gMonPalette_Garbodor_Gigantamax),
SPECIES_PAL(MELMETAL_GIGANTAMAX, gMonPalette_Melmetal_Gigantamax),
SPECIES_PAL(RILLABOOM_GIGANTAMAX, gMonPalette_Rillaboom_Gigantamax),
SPECIES_PAL(CINDERACE_GIGANTAMAX, gMonPalette_Cinderace_Gigantamax),
SPECIES_PAL(INTELEON_GIGANTAMAX, gMonPalette_Inteleon_Gigantamax),
SPECIES_PAL(CORVIKNIGHT_GIGANTAMAX, gMonPalette_Corviknight_Gigantamax),
SPECIES_PAL(ORBEETLE_GIGANTAMAX, gMonPalette_Orbeetle_Gigantamax),
SPECIES_PAL(DREDNAW_GIGANTAMAX, gMonPalette_Drednaw_Gigantamax),
SPECIES_PAL(COALOSSAL_GIGANTAMAX, gMonPalette_Coalossal_Gigantamax),
SPECIES_PAL(FLAPPLE_GIGANTAMAX, gMonPalette_Flapple_Gigantamax),
SPECIES_PAL(APPLETUN_GIGANTAMAX, gMonPalette_Appletun_Gigantamax),
SPECIES_PAL(SANDACONDA_GIGANTAMAX, gMonPalette_Sandaconda_Gigantamax),
SPECIES_PAL(TOXTRICITY_GIGANTAMAX, gMonPalette_Toxtricity_Gigantamax),
SPECIES_PAL(CENTISKORCH_GIGANTAMAX, gMonPalette_Centiskorch_Gigantamax),
SPECIES_PAL(HATTERENE_GIGANTAMAX, gMonPalette_Hatterene_Gigantamax),
SPECIES_PAL(GRIMMSNARL_GIGANTAMAX, gMonPalette_Grimmsnarl_Gigantamax),
SPECIES_PAL(ALCREMIE_GIGANTAMAX, gMonPalette_Alcremie_Gigantamax),
SPECIES_PAL(COPPERAJAH_GIGANTAMAX, gMonPalette_Copperajah_Gigantamax),
SPECIES_PAL(DURALUDON_GIGANTAMAX, gMonPalette_Duraludon_Gigantamax),
SPECIES_PAL(URSHIFU_SINGLE_STRIKE_STYLE_GIGANTAMAX, gMonPalette_Urshifu_Single_Strike_Style_Gigantamax),
SPECIES_PAL(URSHIFU_RAPID_STRIKE_STYLE_GIGANTAMAX, gMonPalette_Urshifu_Rapid_Strike_Style_Gigantamax),
