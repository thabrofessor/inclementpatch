...
SPECIES_SHINY_PAL(MAUSHOLD_THREE, gMonShinyPalette_MausholdThree),
SPECIES_SHINY_PAL(MAUSHOLD_FOUR, gMonShinyPalette_MausholdFour),
...
SPECIES_SHINY_PAL(SQUAWKABILLY_GREEN, gMonShinyPalette_SquawkabillyGreen),
...
SPECIES_SHINY_PAL(DUDUNSPARCE_TWO, gMonShinyPalette_DudunsparceTwo),
...
SPECIES_SHINY_PAL(POLTCHAGEIST_COUNTERFEIT, gMonShinyPalette_PoltchageistCounterfeit),
SPECIES_SHINY_PAL(POLTCHAGEIST_ARTISAN, gMonShinyPalette_PoltchageistArtisan),
SPECIES_SHINY_PAL(SINISTCHA_UNREMARKABLE, gMonShinyPalette_SinistchaUnremarkable),
...
SPECIES_SHINY_PAL(OGERPON_TEAL_MASK_TERA, gMonShinyPalette_OgerponTealMaskTera),
SPECIES_SHINY_PAL(OGERPON_WELLSPRING_MASK_TERA, gMonShinyPalette_OgerponWellspringMaskTera),
SPECIES_SHINY_PAL(OGERPON_HEARTHFLAME_MASK_TERA, gMonShinyPalette_OgerponHearthflameMaskTera),
SPECIES_SHINY_PAL(OGERPON_CORNERSTONE_MASK_TERA, gMonShinyPalette_OgerponCornerstoneMaskTera),
SPECIES_SHINY_PAL(URSALUNA_BLOODMOON, gMonShinyPalette_UrsalunaBloodmoon),
SPECIES_SHINY_PAL(MOTHIM_SANDY_CLOAK, gMonShinyPalette_MothimSandyCloak),
SPECIES_SHINY_PAL(MOTHIM_TRASH_CLOAK, gMonShinyPalette_MothimTrashCloak),
SPECIES_SHINY_PAL(SCATTERBUG_POLAR, gMonShinyPalette_ScatterbugPolar),
SPECIES_SHINY_PAL(SCATTERBUG_TUNDRA, gMonShinyPalette_ScatterbugTundra),
SPECIES_SHINY_PAL(SCATTERBUG_CONTINENTAL, gMonShinyPalette_ScatterbugContinental),
SPECIES_SHINY_PAL(SCATTERBUG_GARDEN, gMonShinyPalette_ScatterbugGarden),
SPECIES_SHINY_PAL(SCATTERBUG_ELEGANT, gMonShinyPalette_ScatterbugElegant),
SPECIES_SHINY_PAL(SCATTERBUG_MEADOW, gMonShinyPalette_ScatterbugMeadow),
SPECIES_SHINY_PAL(SCATTERBUG_MODERN, gMonShinyPalette_ScatterbugModern),
SPECIES_SHINY_PAL(SCATTERBUG_MARINE, gMonShinyPalette_ScatterbugMarine),
SPECIES_SHINY_PAL(SCATTERBUG_ARCHIPELAGO, gMonShinyPalette_ScatterbugArchipelago),
SPECIES_SHINY_PAL(SCATTERBUG_HIGH_PLAINS, gMonShinyPalette_ScatterbugHighPlains),
SPECIES_SHINY_PAL(SCATTERBUG_SANDSTORM, gMonShinyPalette_ScatterbugSandstorm),
SPECIES_SHINY_PAL(SCATTERBUG_RIVER, gMonShinyPalette_ScatterbugRiver),
SPECIES_SHINY_PAL(SCATTERBUG_MONSOON, gMonShinyPalette_ScatterbugMonsoon),
SPECIES_SHINY_PAL(SCATTERBUG_SAVANNA, gMonShinyPalette_ScatterbugSavanna),
SPECIES_SHINY_PAL(SCATTERBUG_SUN, gMonShinyPalette_ScatterbugSun),
SPECIES_SHINY_PAL(SCATTERBUG_OCEAN, gMonShinyPalette_ScatterbugOcean),
SPECIES_SHINY_PAL(SCATTERBUG_JUNGLE, gMonShinyPalette_ScatterbugJungle),
SPECIES_SHINY_PAL(SCATTERBUG_FANCY, gMonShinyPalette_ScatterbugFancy),
SPECIES_SHINY_PAL(SCATTERBUG_POKE_BALL, gMonShinyPalette_ScatterbugPokeBall),
SPECIES_SHINY_PAL(SPEWPA_POLAR, gMonShinyPalette_SpewpaPolar),
SPECIES_SHINY_PAL(SPEWPA_TUNDRA, gMonShinyPalette_SpewpaTundra),
SPECIES_SHINY_PAL(SPEWPA_CONTINENTAL, gMonShinyPalette_SpewpaContinental),
SPECIES_SHINY_PAL(SPEWPA_GARDEN, gMonShinyPalette_SpewpaGarden),
SPECIES_SHINY_PAL(SPEWPA_ELEGANT, gMonShinyPalette_SpewpaElegant),
SPECIES_SHINY_PAL(SPEWPA_MEADOW, gMonShinyPalette_SpewpaMeadow),
SPECIES_SHINY_PAL(SPEWPA_MODERN, gMonShinyPalette_SpewpaModern),
SPECIES_SHINY_PAL(SPEWPA_MARINE, gMonShinyPalette_SpewpaMarine),
SPECIES_SHINY_PAL(SPEWPA_ARCHIPELAGO, gMonShinyPalette_SpewpaArchipelago),
SPECIES_SHINY_PAL(SPEWPA_HIGH_PLAINS, gMonShinyPalette_SpewpaHighPlains),
SPECIES_SHINY_PAL(SPEWPA_SANDSTORM, gMonShinyPalette_SpewpaSandstorm),
SPECIES_SHINY_PAL(SPEWPA_RIVER, gMonShinyPalette_SpewpaRiver),
SPECIES_SHINY_PAL(SPEWPA_MONSOON, gMonShinyPalette_SpewpaMonsoon),
SPECIES_SHINY_PAL(SPEWPA_SAVANNA, gMonShinyPalette_SpewpaSavanna),
SPECIES_SHINY_PAL(SPEWPA_SUN, gMonShinyPalette_SpewpaSun),
SPECIES_SHINY_PAL(SPEWPA_OCEAN, gMonShinyPalette_SpewpaOcean),
SPECIES_SHINY_PAL(SPEWPA_JUNGLE, gMonShinyPalette_SpewpaJungle),
SPECIES_SHINY_PAL(SPEWPA_FANCY, gMonShinyPalette_SpewpaFancy),
SPECIES_SHINY_PAL(SPEWPA_POKE_BALL, gMonShinyPalette_SpewpaPokeBall),
SPECIES_SHINY_PAL(PIKACHU_PARTNER, gMonShinyPalette_PikachuPartner),
SPECIES_SHINY_PAL(EEVEE_PARTNER, gMonShinyPalette_EeveePartner),
SPECIES_SHINY_PAL(LUGIA_SHADOW, gMonShinyPalette_LugiaShadow),
...
SPECIES_SHINY_PAL(ETERNATUS_ETERNAMAX, gMonShinyPalette_EternatusEternamax),
SPECIES_SHINY_PAL(URSHIFU_SINGLE_STRIKE_GIGANTAMAX, gMonShinyPalette_UrshifuSingleStrikeGigantamax),
SPECIES_SHINY_PAL(URSHIFU_RAPID_STRIKE_GIGANTAMAX, gMonShinyPalette_UrshifuRapidStrikeGigantamax),
