...
SPECIES_SPRITE(OINKOLOGNE_MALE, gMonFrontPic_OinkologneMale),
...
SPECIES_SPRITE(MAUSHOLD_THREE, gMonFrontPic_MausholdThree),
SPECIES_SPRITE(MAUSHOLD_FOUR, gMonFrontPic_MausholdFour),
...
SPECIES_SPRITE(SQUAWKABILLY_GREEN, gMonFrontPic_SquawkabillyGreen),
...
SPECIES_SPRITE(PALAFIN_ZERO, gMonFrontPic_PalafinZero),
...
SPECIES_SPRITE(TATSUGIRI_CURLY, gMonFrontPic_TatsugiriCurly),
...
SPECIES_SPRITE(DUDUNSPARCE_TWO, gMonFrontPic_DudunsparceTwo),
...
SPECIES_SPRITE(TAUROS_PALDEAN_COMBAT_BREED, gMonFrontPic_TaurosPaldeanCombatBreed),
SPECIES_SPRITE(TAUROS_PALDEAN_BLAZE_BREED, gMonFrontPic_TaurosPaldeanBlazeBreed),
SPECIES_SPRITE(TAUROS_PALDEAN_AQUA_BREED, gMonFrontPic_TaurosPaldeanAquaBreed),
...
SPECIES_SPRITE(POLTCHAGEIST_COUNTERFEIT, gMonFrontPic_PoltchageistCounterfeit),
SPECIES_SPRITE(POLTCHAGEIST_ARTISAN, gMonFrontPic_PoltchageistArtisan),
SPECIES_SPRITE(SINISTCHA_UNREMARKABLE, gMonFrontPic_SinistchaUnremarkable),
...
SPECIES_SPRITE(OGERPON_TEAL, gMonFrontPic_OgerponTeal),
...
SPECIES_SPRITE(OGERPON_TEAL_MASK_TERA, gMonFrontPic_OgerponTealMaskTera),
SPECIES_SPRITE(OGERPON_WELLSPRING_MASK_TERA, gMonFrontPic_OgerponWellspringMaskTera),
SPECIES_SPRITE(OGERPON_HEARTHFLAME_MASK_TERA, gMonFrontPic_OgerponHearthflameMaskTera),
SPECIES_SPRITE(OGERPON_CORNERSTONE_MASK_TERA, gMonFrontPic_OgerponCornerstoneMaskTera),
SPECIES_SPRITE(URSALUNA_BLOODMOON, gMonFrontPic_UrsalunaBloodmoon),
SPECIES_SPRITE(MOTHIM_SANDY_CLOAK, gMonFrontPic_MothimSandyCloak),
SPECIES_SPRITE(MOTHIM_TRASH_CLOAK, gMonFrontPic_MothimTrashCloak),
SPECIES_SPRITE(SCATTERBUG_POLAR, gMonFrontPic_ScatterbugPolar),
SPECIES_SPRITE(SCATTERBUG_TUNDRA, gMonFrontPic_ScatterbugTundra),
SPECIES_SPRITE(SCATTERBUG_CONTINENTAL, gMonFrontPic_ScatterbugContinental),
SPECIES_SPRITE(SCATTERBUG_GARDEN, gMonFrontPic_ScatterbugGarden),
SPECIES_SPRITE(SCATTERBUG_ELEGANT, gMonFrontPic_ScatterbugElegant),
SPECIES_SPRITE(SCATTERBUG_MEADOW, gMonFrontPic_ScatterbugMeadow),
SPECIES_SPRITE(SCATTERBUG_MODERN, gMonFrontPic_ScatterbugModern),
SPECIES_SPRITE(SCATTERBUG_MARINE, gMonFrontPic_ScatterbugMarine),
SPECIES_SPRITE(SCATTERBUG_ARCHIPELAGO, gMonFrontPic_ScatterbugArchipelago),
SPECIES_SPRITE(SCATTERBUG_HIGH_PLAINS, gMonFrontPic_ScatterbugHighPlains),
SPECIES_SPRITE(SCATTERBUG_SANDSTORM, gMonFrontPic_ScatterbugSandstorm),
SPECIES_SPRITE(SCATTERBUG_RIVER, gMonFrontPic_ScatterbugRiver),
SPECIES_SPRITE(SCATTERBUG_MONSOON, gMonFrontPic_ScatterbugMonsoon),
SPECIES_SPRITE(SCATTERBUG_SAVANNA, gMonFrontPic_ScatterbugSavanna),
SPECIES_SPRITE(SCATTERBUG_SUN, gMonFrontPic_ScatterbugSun),
SPECIES_SPRITE(SCATTERBUG_OCEAN, gMonFrontPic_ScatterbugOcean),
SPECIES_SPRITE(SCATTERBUG_JUNGLE, gMonFrontPic_ScatterbugJungle),
SPECIES_SPRITE(SCATTERBUG_FANCY, gMonFrontPic_ScatterbugFancy),
SPECIES_SPRITE(SCATTERBUG_POKE_BALL, gMonFrontPic_ScatterbugPokeBall),
SPECIES_SPRITE(SPEWPA_POLAR, gMonFrontPic_SpewpaPolar),
SPECIES_SPRITE(SPEWPA_TUNDRA, gMonFrontPic_SpewpaTundra),
SPECIES_SPRITE(SPEWPA_CONTINENTAL, gMonFrontPic_SpewpaContinental),
SPECIES_SPRITE(SPEWPA_GARDEN, gMonFrontPic_SpewpaGarden),
SPECIES_SPRITE(SPEWPA_ELEGANT, gMonFrontPic_SpewpaElegant),
SPECIES_SPRITE(SPEWPA_MEADOW, gMonFrontPic_SpewpaMeadow),
SPECIES_SPRITE(SPEWPA_MODERN, gMonFrontPic_SpewpaModern),
SPECIES_SPRITE(SPEWPA_MARINE, gMonFrontPic_SpewpaMarine),
SPECIES_SPRITE(SPEWPA_ARCHIPELAGO, gMonFrontPic_SpewpaArchipelago),
SPECIES_SPRITE(SPEWPA_HIGH_PLAINS, gMonFrontPic_SpewpaHighPlains),
SPECIES_SPRITE(SPEWPA_SANDSTORM, gMonFrontPic_SpewpaSandstorm),
SPECIES_SPRITE(SPEWPA_RIVER, gMonFrontPic_SpewpaRiver),
SPECIES_SPRITE(SPEWPA_MONSOON, gMonFrontPic_SpewpaMonsoon),
SPECIES_SPRITE(SPEWPA_SAVANNA, gMonFrontPic_SpewpaSavanna),
SPECIES_SPRITE(SPEWPA_SUN, gMonFrontPic_SpewpaSun),
SPECIES_SPRITE(SPEWPA_OCEAN, gMonFrontPic_SpewpaOcean),
SPECIES_SPRITE(SPEWPA_JUNGLE, gMonFrontPic_SpewpaJungle),
SPECIES_SPRITE(SPEWPA_FANCY, gMonFrontPic_SpewpaFancy),
SPECIES_SPRITE(SPEWPA_POKE_BALL, gMonFrontPic_SpewpaPokeBall),
SPECIES_SPRITE(PIKACHU_PARTNER, gMonFrontPic_PikachuPartner),
SPECIES_SPRITE(EEVEE_PARTNER, gMonFrontPic_EeveePartner),
SPECIES_SPRITE(LUGIA_SHADOW, gMonFrontPic_LugiaShadow),
...
SPECIES_SPRITE(URSHIFU_SINGLE_STRIKE_STYLE_GIGANTAMAX, gMonFrontPic_UrshifuSingleStrikeStyleGigantamax),
SPECIES_SPRITE(URSHIFU_RAPID_STRIKE_STYLE_GIGANTAMAX, gMonFrontPic_UrshifuRapidStrikeStyleGigantamax),
SPECIES_SPRITE(ORIGIN_MEW, gMonFrontPic_OriginMew),
SPECIES_SPRITE(ARMOR_MEWTWO, gMonFrontPic_ArmorMewtwo),
