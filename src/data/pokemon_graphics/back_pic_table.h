...
SPECIES_SPRITE(MAUSHOLD_THREE, gMonBackPic_MausholdThree),
SPECIES_SPRITE(MAUSHOLD_FOUR, gMonBackPic_MausholdFour),
...
SPECIES_SPRITE(SQUAWKABILLY_GREEN, gMonBackPic_SquawkabillyGreen),
...
SPECIES_SPRITE(PALAFIN_ZERO, gMonBackPic_PalafinZero),
...
SPECIES_SPRITE(TATSUGIRI_CURLY, gMonBackPic_TatsugiriCurly),
...
SPECIES_SPRITE(DUDUNSPARCE_TWO, gMonBackPic_DudunsparceTwo),
...
SPECIES_SPRITE(TAUROS_PALDEAN_COMBAT_BREED, gMonBackPic_TaurosPaldeanCombatBreed),
SPECIES_SPRITE(TAUROS_PALDEAN_BLAZE_BREED, gMonBackPic_TaurosPaldeanBlazeBreed),
SPECIES_SPRITE(TAUROS_PALDEAN_AQUA_BREED, gMonBackPic_TaurosPaldeanAquaBreed),
...
SPECIES_SPRITE(POLTCHAGEIST_COUNTERFEIT, gMonBackPic_PoltchageistCounterfeit),
SPECIES_SPRITE(POLTCHAGEIST_ARTISAN, gMonBackPic_PoltchageistArtisan),
SPECIES_SPRITE(SINISTCHA_UNREMARKABLE, gMonBackPic_SinistchaUnremarkable),
...
SPECIES_SPRITE(OGERPON_TEAL_MASK_TERA, gMonBackPic_OgerponTealMaskTera),
SPECIES_SPRITE(OGERPON_WELLSPRING_MASK_TERA, gMonBackPic_OgerponWellspringMaskTera),
SPECIES_SPRITE(OGERPON_HEARTHFLAME_MASK_TERA, gMonBackPic_OgerponHearthflameMaskTera),
SPECIES_SPRITE(OGERPON_CORNERSTONE_MASK_TERA, gMonBackPic_OgerponCornerstoneMaskTera),
SPECIES_SPRITE(URSALUNA_BLOODMOON, gMonBackPic_UrsalunaBloodmoon),
SPECIES_SPRITE(MOTHIM_SANDY_CLOAK, gMonBackPic_MothimSandyCloak),
SPECIES_SPRITE(MOTHIM_TRASH_CLOAK, gMonBackPic_MothimTrashCloak),
SPECIES_SPRITE(SCATTERBUG_POLAR, gMonBackPic_ScatterbugPolar),
SPECIES_SPRITE(SCATTERBUG_TUNDRA, gMonBackPic_ScatterbugTundra),
SPECIES_SPRITE(SCATTERBUG_CONTINENTAL, gMonBackPic_ScatterbugContinental),
SPECIES_SPRITE(SCATTERBUG_GARDEN, gMonBackPic_ScatterbugGarden),
SPECIES_SPRITE(SCATTERBUG_ELEGANT, gMonBackPic_ScatterbugElegant),
SPECIES_SPRITE(SCATTERBUG_MEADOW, gMonBackPic_ScatterbugMeadow),
SPECIES_SPRITE(SCATTERBUG_MODERN, gMonBackPic_ScatterbugModern),
SPECIES_SPRITE(SCATTERBUG_MARINE, gMonBackPic_ScatterbugMarine),
SPECIES_SPRITE(SCATTERBUG_ARCHIPELAGO, gMonBackPic_ScatterbugArchipelago),
SPECIES_SPRITE(SCATTERBUG_HIGH_PLAINS, gMonBackPic_ScatterbugHighPlains),
SPECIES_SPRITE(SCATTERBUG_SANDSTORM, gMonBackPic_ScatterbugSandstorm),
SPECIES_SPRITE(SCATTERBUG_RIVER, gMonBackPic_ScatterbugRiver),
SPECIES_SPRITE(SCATTERBUG_MONSOON, gMonBackPic_ScatterbugMonsoon),
SPECIES_SPRITE(SCATTERBUG_SAVANNA, gMonBackPic_ScatterbugSavanna),
SPECIES_SPRITE(SCATTERBUG_SUN, gMonBackPic_ScatterbugSun),
SPECIES_SPRITE(SCATTERBUG_OCEAN, gMonBackPic_ScatterbugOcean),
SPECIES_SPRITE(SCATTERBUG_JUNGLE, gMonBackPic_ScatterbugJungle),
SPECIES_SPRITE(SCATTERBUG_FANCY, gMonBackPic_ScatterbugFancy),
SPECIES_SPRITE(SCATTERBUG_POKE_BALL, gMonBackPic_ScatterbugPokeBall),
SPECIES_SPRITE(SPEWPA_POLAR, gMonBackPic_SpewpaPolar),
SPECIES_SPRITE(SPEWPA_TUNDRA, gMonBackPic_SpewpaTundra),
SPECIES_SPRITE(SPEWPA_CONTINENTAL, gMonBackPic_SpewpaContinental),
SPECIES_SPRITE(SPEWPA_GARDEN, gMonBackPic_SpewpaGarden),
SPECIES_SPRITE(SPEWPA_ELEGANT, gMonBackPic_SpewpaElegant),
SPECIES_SPRITE(SPEWPA_MEADOW, gMonBackPic_SpewpaMeadow),
SPECIES_SPRITE(SPEWPA_MODERN, gMonBackPic_SpewpaModern),
SPECIES_SPRITE(SPEWPA_MARINE, gMonBackPic_SpewpaMarine),
SPECIES_SPRITE(SPEWPA_ARCHIPELAGO, gMonBackPic_SpewpaArchipelago),
SPECIES_SPRITE(SPEWPA_HIGH_PLAINS, gMonBackPic_SpewpaHighPlains),
SPECIES_SPRITE(SPEWPA_SANDSTORM, gMonBackPic_SpewpaSandstorm),
SPECIES_SPRITE(SPEWPA_RIVER, gMonBackPic_SpewpaRiver),
SPECIES_SPRITE(SPEWPA_MONSOON, gMonBackPic_SpewpaMonsoon),
SPECIES_SPRITE(SPEWPA_SAVANNA, gMonBackPic_SpewpaSavanna),
SPECIES_SPRITE(SPEWPA_SUN, gMonBackPic_SpewpaSun),
SPECIES_SPRITE(SPEWPA_OCEAN, gMonBackPic_SpewpaOcean),
SPECIES_SPRITE(SPEWPA_JUNGLE, gMonBackPic_SpewpaJungle),
SPECIES_SPRITE(SPEWPA_FANCY, gMonBackPic_SpewpaFancy),
SPECIES_SPRITE(SPEWPA_POKE_BALL, gMonBackPic_SpewpaPokeBall),
SPECIES_SPRITE(PIKACHU_PARTNER, gMonBackPic_PikachuPartner),
SPECIES_SPRITE(EEVEE_PARTNER, gMonBackPic_EeveePartner),
SPECIES_SPRITE(LUGIA_SHADOW, gMonBackPic_LugiaShadow),
...
SPECIES_SPRITE(URSHIFU_SINGLE_STRIKE_STYLE_GIGANTAMAX, gMonBackPic_UrshifuSingleStrikeStyleGigantamax),
SPECIES_SPRITE(URSHIFU_RAPID_STRIKE_STYLE_GIGANTAMAX, gMonBackPic_UrshifuRapidStrikeStyleGigantamax),
SPECIES_SPRITE(ORIGIN_MEW, gMonBackPic_OriginMew),
SPECIES_SPRITE(ARMOR_MEWTWO, gMonBackPic_ArmorMewtwo),
