...
SPECIES_SPRITE(URSHIFU_SINGLE_STRIKE_GIGANTAMAX, gMonBackPic_UrshifuSingleStrikeGigantamax),
SPECIES_SPRITE(URSHIFU_RAPID_STRIKE_GIGANTAMAX, gMonBackPic_UrshifuRapidStrikeGigantamax),
