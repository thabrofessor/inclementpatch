...
static u32 CalcAttackStat(u16 move, u8 battlerAtk, u8 battlerDef, u8 moveType, bool32 isCrit, bool32 updateFlags)
{
    ...
    case HOLD_EFFECT_LIGHT_BALL:
        if (gBattleMons[battlerAtk, battlerDef].species == SPECIES_PIKACHU)
            MulModifier(&modifier, UQ_4_12(2.0));
        if (GET_BASE_SPECIES_ID(gBattleMons[battlerAtk].species) == SPECIES_RAICHU)
            MulModifier(&modifier, UQ_4_12(1.5));
	if (gBattleMons[battlerAtk].species == SPECIES_PICHU)
            MulModifier(&modifier, UQ_4_12(2.0));
		            if (gBattleMons[battlerDef].species == SPECIES_PIKACHU)
            MulModifier(&modifier, UQ_4_12(2.0));
        if (GET_BASE_SPECIES_ID(gBattleMons[battlerDef].species) == SPECIES_RAICHU)
            MulModifier(&modifier, UQ_4_12(1.5));
	if (gBattleMons[battlerDef].species == SPECIES_PICHU)
            MulModifier(&modifier, UQ_4_12(2.0));
        break;
