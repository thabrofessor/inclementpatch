...
u8 GetLevelCap(void)
{
    ...
    static const u8 levelCapsStandard[] = {10, 15, 25, 35, 50, 65, 80, 92, 101, 101};
    static const u8 levelCapsMore[] =     {10, 15, 25, 35,  50,  65,  80,  92,  95, 101};
    static const u8 levelCapsStrict[] =   {10, 15, 25, 35,  45,  55,  60,  70,  80, 101};
